...
-(void)eventHandler: (NSNotification *) notification
{
    ...
    NSLog(@"\n\nSe realiza la llamada a POST. La url es: %@\n\n", post);
...
-(NSString *) errorReportAsync:(NSString*) error
{
    ...
    NSLog(@"AOViewController -> urlServlet => %@", urlServlet);
