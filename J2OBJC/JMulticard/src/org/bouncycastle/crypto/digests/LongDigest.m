...
#error "org/bouncycastle/crypto/digests/LongDigest must be compiled with ARC (-fobjc-arc)"
#endif
...
#line 1 "/Users/desarrolloabamobile/Downloads/jmulticard-ios/src/main/java/org/bouncycastle/crypto/digests/LongDigest.java"
...
+ (void)initialize {
  if (self == [OrgBouncycastleCryptoDigestsLongDigest class]) {
    OrgBouncycastleCryptoDigestsLongDigest_K = [IOSLongArray newArrayWithLongs:(jlong[]){
#line 390
