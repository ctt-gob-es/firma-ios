...
#error "org/bouncycastle/math/ec/custom/sec/SecT163K1Point must be compiled with ARC (-fobjc-arc)"
#endif

#line 1 "/Users/desarrolloabamobile/Downloads/jmulticard-ios/src/main/java/org/bouncycastle/math/ec/custom/sec/SecT163K1Point.java"
...
#line 24
  return new_OrgBouncycastleMathEcCustomSecSecT163K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(nil, [self getAffineXCoord], [self getAffineYCoord]);
}
...
#line 137
      return new_OrgBouncycastleMathEcCustomSecSecT163K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, X3, [((OrgBouncycastleMathEcECCurve *) nil_chk(curve)) getB]);
    }
...
#line 172
  return new_OrgBouncycastleMathEcCustomSecSecT163K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve, X3, L3, [IOSObjectArray newArrayWithObjects:(id[]){ Z3 } count:1 type:OrgBouncycastleMathEcECFieldElement_class_()]);
}
...
#line 200
    return new_OrgBouncycastleMathEcCustomSecSecT163K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, T, [((OrgBouncycastleMathEcECCurve *) nil_chk(curve)) getB]);
  }
...
#line 265
    return new_OrgBouncycastleMathEcCustomSecSecT163K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_(curve, A, [((OrgBouncycastleMathEcECCurve *) nil_chk(curve)) getB]);
  }
...
#line 290
  OrgBouncycastleMathEcECFieldElement *Z = IOSObjectArray_Get(nil_chk(zs_), 0);
  return new_OrgBouncycastleMathEcCustomSecSecT163K1Point_initWithOrgBouncycastleMathEcECCurve_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElement_withOrgBouncycastleMathEcECFieldElementArray_(curve_, X, [((OrgBouncycastleMathEcECFieldElement *) nil_chk(L)) addWithOrgBouncycastleMathEcECFieldElement:Z], [IOSObjectArray newArrayWithObjects:(id[]){ Z } count:1 type:OrgBouncycastleMathEcECFieldElement_class_()]);
}
