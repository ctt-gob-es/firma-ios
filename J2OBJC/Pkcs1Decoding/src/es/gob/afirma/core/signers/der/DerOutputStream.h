...
#pragma push_macro("INCLUDE_ALL_EsGobAfirmaCoreSignersDerDerOutputStream")
#ifdef RESTRICT_EsGobAfirmaCoreSignersDerDerOutputStream
#define INCLUDE_ALL_EsGobAfirmaCoreSignersDerDerOutputStream 0
#else
#define INCLUDE_ALL_EsGobAfirmaCoreSignersDerDerOutputStream 1
#endif
#undef RESTRICT_EsGobAfirmaCoreSignersDerDerOutputStream

#if !defined (EsGobAfirmaCoreSignersDerDerOutputStream_) && (INCLUDE_ALL_EsGobAfirmaCoreSignersDerDerOutputStream || defined(INCLUDE_EsGobAfirmaCoreSignersDerDerOutputStream))
#define EsGobAfirmaCoreSignersDerDerOutputStream_

#define RESTRICT_JavaIoByteArrayOutputStream 1
#define INCLUDE_JavaIoByteArrayOutputStream 1
#include "java/io/ByteArrayOutputStream.h"

#define RESTRICT_EsGobAfirmaCoreSignersDerDerEncoder 1
 ...
 */
@interface EsGobAfirmaCoreSignersDerDerOutputStream : JavaIoByteArrayOutputStream < EsGobAfirmaCoreSignersDerDerEncoder >
...
/*!
 @brief Write the current contents of this <code>DerOutputStream</code>
...
J2OBJC_STATIC_INIT(EsGobAfirmaCoreSignersDerDerOutputStream)

FOUNDATION_EXPORT void EsGobAfirmaCoreSignersDerDerOutputStream_initWithInt_(EsGobAfirmaCoreSignersDerDerOutputStream *self, jint size);

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStream *new_EsGobAfirmaCoreSignersDerDerOutputStream_initWithInt_(jint size) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStream *create_EsGobAfirmaCoreSignersDerDerOutputStream_initWithInt_(jint size);

FOUNDATION_EXPORT void EsGobAfirmaCoreSignersDerDerOutputStream_init(EsGobAfirmaCoreSignersDerDerOutputStream *self);

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStream *new_EsGobAfirmaCoreSignersDerDerOutputStream_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStream *create_EsGobAfirmaCoreSignersDerDerOutputStream_init(void);

J2OBJC_TYPE_LITERAL_HEADER(EsGobAfirmaCoreSignersDerDerOutputStream)

#endif

#pragma pop_macro("INCLUDE_ALL_EsGobAfirmaCoreSignersDerDerOutputStream")
