...
#pragma push_macro("INCLUDE_ALL_EsGobAfirmaCoreSignersDerByteArrayLexOrder")
#ifdef RESTRICT_EsGobAfirmaCoreSignersDerByteArrayLexOrder
#define INCLUDE_ALL_EsGobAfirmaCoreSignersDerByteArrayLexOrder 0
#else
#define INCLUDE_ALL_EsGobAfirmaCoreSignersDerByteArrayLexOrder 1
#endif
#undef RESTRICT_EsGobAfirmaCoreSignersDerByteArrayLexOrder

#if !defined (EsGobAfirmaCoreSignersDerByteArrayLexOrder_) && (INCLUDE_ALL_EsGobAfirmaCoreSignersDerByteArrayLexOrder || defined(INCLUDE_EsGobAfirmaCoreSignersDerByteArrayLexOrder))
...
#pragma pop_macro("INCLUDE_ALL_EsGobAfirmaCoreSignersDerByteArrayLexOrder")
