...
#line 1 "/Users/desarrolloabamobile/Documents/JAVA/pades-ios/src/main/java/com/ICC_Transform.java"
...
#line 138
  if (transformHandle_ != 0) {
    ComNativeCMM_cmmDeleteTransformWithLong_(transformHandle_);
  }
}
...
#line 152
  ComNativeCMM_cmmTranslateColorsWithLong_withComNativeImageFormat_withComNativeImageFormat_(transformHandle_, src, dst);
}
...
#line 81
  self->transformHandle_ = ComNativeCMM_cmmCreateMultiprofileTransformWithLongArray_withIntArray_(profileHandles, renderIntents);
...
#line 128
  self->transformHandle_ = ComNativeCMM_cmmCreateMultiprofileTransformWithLongArray_withIntArray_(profileHandles, renderingIntents);
