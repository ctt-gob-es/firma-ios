...
#pragma push_macro("INCLUDE_ALL_CertID")
#ifdef RESTRICT_CertID
#define INCLUDE_ALL_CertID 0
#else
#define INCLUDE_ALL_CertID 1
#endif
#undef RESTRICT_CertID

#if !defined (OrgSpongycastleAsn1OcspCertID_) && (INCLUDE_ALL_CertID || defined(INCLUDE_OrgSpongycastleAsn1OcspCertID))
...
#pragma pop_macro("INCLUDE_ALL_CertID")
