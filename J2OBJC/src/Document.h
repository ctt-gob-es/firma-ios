...
#pragma push_macro("INCLUDE_ALL_Document")
#ifdef RESTRICT_Document
#define INCLUDE_ALL_Document 0
#else
#define INCLUDE_ALL_Document 1
#endif
#undef RESTRICT_Document

#if !defined (ComAowagieTextDocument_) && (INCLUDE_ALL_Document || defined(INCLUDE_ComAowagieTextDocument))
...
#pragma pop_macro("INCLUDE_ALL_Document")
