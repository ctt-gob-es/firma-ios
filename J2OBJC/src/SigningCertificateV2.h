...
#pragma push_macro("INCLUDE_ALL_SigningCertificateV2")
#ifdef RESTRICT_SigningCertificateV2
#define INCLUDE_ALL_SigningCertificateV2 0
#else
#define INCLUDE_ALL_SigningCertificateV2 1
#endif
#undef RESTRICT_SigningCertificateV2

#if !defined (OrgSpongycastleAsn1EssSigningCertificateV2_) && (INCLUDE_ALL_SigningCertificateV2 || defined(INCLUDE_OrgSpongycastleAsn1EssSigningCertificateV2))
...
#pragma pop_macro("INCLUDE_ALL_SigningCertificateV2")
