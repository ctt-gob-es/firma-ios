...
#pragma push_macro("INCLUDE_ALL_SecP256K1Field")
#ifdef RESTRICT_SecP256K1Field
#define INCLUDE_ALL_SecP256K1Field 0
#else
#define INCLUDE_ALL_SecP256K1Field 1
#endif
#undef RESTRICT_SecP256K1Field

#if !defined (OrgSpongycastleMathEcCustomSecSecP256K1Field_) && (INCLUDE_ALL_SecP256K1Field || defined(INCLUDE_OrgSpongycastleMathEcCustomSecSecP256K1Field))
...
#pragma pop_macro("INCLUDE_ALL_SecP256K1Field")
