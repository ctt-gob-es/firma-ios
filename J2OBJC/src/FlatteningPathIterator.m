...
//  source: /Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/harmony/java/awt/geom/FlatteningPathIterator.java
//
...
#error "FlatteningPathIterator must be compiled with ARC (-fobjc-arc)"
#endif
...
#line 1 "/Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/harmony/java/awt/geom/FlatteningPathIterator.java"
...
#line 263
    @throw new_JavaUtilNoSuchElementException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.4Bx"));
  }
  [self evaluate];
  jint type = bufType_;
...
#line 115
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.206"));
  }
  if (limit < 0) {
    
#line 119
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.207"));
  }
  if (path == nil) {
    
#line 123
    @throw new_JavaLangNullPointerException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.208"));
  }
  self->p_ = path;
