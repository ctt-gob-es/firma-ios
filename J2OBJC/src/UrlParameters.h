...
#pragma push_macro("INCLUDE_ALL_UrlParameters")
#ifdef RESTRICT_UrlParameters
#define INCLUDE_ALL_UrlParameters 0
#else
#define INCLUDE_ALL_UrlParameters 1
#endif
#undef RESTRICT_UrlParameters

#if !defined (EsGobAfirmaCoreMiscProtocolUrlParameters_) && (INCLUDE_ALL_UrlParameters || defined(INCLUDE_EsGobAfirmaCoreMiscProtocolUrlParameters))
...
#pragma pop_macro("INCLUDE_ALL_UrlParameters")
