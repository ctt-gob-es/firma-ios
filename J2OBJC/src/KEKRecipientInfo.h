...
#pragma push_macro("INCLUDE_ALL_KEKRecipientInfo")
#ifdef RESTRICT_KEKRecipientInfo
#define INCLUDE_ALL_KEKRecipientInfo 0
#else
#define INCLUDE_ALL_KEKRecipientInfo 1
#endif
#undef RESTRICT_KEKRecipientInfo

#if !defined (OrgSpongycastleAsn1CmsKEKRecipientInfo_) && (INCLUDE_ALL_KEKRecipientInfo || defined(INCLUDE_OrgSpongycastleAsn1CmsKEKRecipientInfo))
...
#pragma pop_macro("INCLUDE_ALL_KEKRecipientInfo")
