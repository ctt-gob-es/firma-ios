...
//  source: /Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/com/aowagie/text/pdf/PdfReader.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_PdfReader")
#ifdef RESTRICT_PdfReader
#define INCLUDE_ALL_PdfReader 0
#else
#define INCLUDE_ALL_PdfReader 1
#endif
#undef RESTRICT_PdfReader

#if !defined (ComAowagieTextPdfPdfReader_) && (INCLUDE_ALL_PdfReader || defined(INCLUDE_ComAowagieTextPdfPdfReader))
...
#if !defined (ComAowagieTextPdfPdfReader_PageRefs_) && (INCLUDE_ALL_PdfReader || defined(INCLUDE_ComAowagieTextPdfPdfReader_PageRefs))
...
#pragma pop_macro("INCLUDE_ALL_PdfReader")
