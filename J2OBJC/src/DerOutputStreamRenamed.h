...
#pragma push_macro("INCLUDE_ALL_DerOutputStreamRenamed")
#ifdef RESTRICT_DerOutputStreamRenamed
#define INCLUDE_ALL_DerOutputStreamRenamed 0
#else
#define INCLUDE_ALL_DerOutputStreamRenamed 1
#endif
#undef RESTRICT_DerOutputStreamRenamed

#if !defined (EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_) && (INCLUDE_ALL_DerOutputStreamRenamed || defined(INCLUDE_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed))
#define EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_
 ...
 */
@interface EsGobAfirmaCoreSignersDerDerOutputStreamRenamed : JavaIoByteArrayOutputStream < EsGobAfirmaCoreSignersDerDerEncoder >
...
/*!
 @brief Write the current contents of this <code>DerOutputStreamRenamed</code>
...
J2OBJC_STATIC_INIT(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed)

FOUNDATION_EXPORT void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, jint size);

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *new_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(jint size) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *create_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(jint size);

FOUNDATION_EXPORT void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self);

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *new_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *create_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init(void);

J2OBJC_TYPE_LITERAL_HEADER(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed)

#endif

#pragma pop_macro("INCLUDE_ALL_DerOutputStreamRenamed")
