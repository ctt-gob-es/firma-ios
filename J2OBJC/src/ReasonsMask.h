...
#pragma push_macro("INCLUDE_ALL_ReasonsMask")
#ifdef RESTRICT_ReasonsMask
#define INCLUDE_ALL_ReasonsMask 0
#else
#define INCLUDE_ALL_ReasonsMask 1
#endif
#undef RESTRICT_ReasonsMask

#if !defined (OrgSpongycastleJceProviderReasonsMask_) && (INCLUDE_ALL_ReasonsMask || defined(INCLUDE_OrgSpongycastleJceProviderReasonsMask))
...
#pragma pop_macro("INCLUDE_ALL_ReasonsMask")
