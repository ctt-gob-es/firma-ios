...
#pragma push_macro("INCLUDE_ALL_ASN1Integer")
#ifdef RESTRICT_ASN1Integer
#define INCLUDE_ALL_ASN1Integer 0
#else
#define INCLUDE_ALL_ASN1Integer 1
#endif
#undef RESTRICT_ASN1Integer

#if !defined (OrgSpongycastleAsn1ASN1Integer_) && (INCLUDE_ALL_ASN1Integer || defined(INCLUDE_OrgSpongycastleAsn1ASN1Integer))
...
#pragma pop_macro("INCLUDE_ALL_ASN1Integer")
