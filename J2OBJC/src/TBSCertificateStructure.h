...
#pragma push_macro("INCLUDE_ALL_TBSCertificateStructure")
#ifdef RESTRICT_TBSCertificateStructure
#define INCLUDE_ALL_TBSCertificateStructure 0
#else
#define INCLUDE_ALL_TBSCertificateStructure 1
#endif
#undef RESTRICT_TBSCertificateStructure

#if !defined (OrgSpongycastleAsn1X509TBSCertificateStructure_) && (INCLUDE_ALL_TBSCertificateStructure || defined(INCLUDE_OrgSpongycastleAsn1X509TBSCertificateStructure))
...
#pragma pop_macro("INCLUDE_ALL_TBSCertificateStructure")
