...
#pragma push_macro("INCLUDE_ALL_DLSequence")
#ifdef RESTRICT_DLSequence
#define INCLUDE_ALL_DLSequence 0
#else
#define INCLUDE_ALL_DLSequence 1
#endif
#undef RESTRICT_DLSequence

#if !defined (OrgSpongycastleAsn1DLSequence_) && (INCLUDE_ALL_DLSequence || defined(INCLUDE_OrgSpongycastleAsn1DLSequence))
...
#pragma pop_macro("INCLUDE_ALL_DLSequence")
