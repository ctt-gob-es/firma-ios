...
#pragma push_macro("INCLUDE_ALL_StreamCipher")
#ifdef RESTRICT_StreamCipher
#define INCLUDE_ALL_StreamCipher 0
#else
#define INCLUDE_ALL_StreamCipher 1
#endif
#undef RESTRICT_StreamCipher

#if !defined (OrgSpongycastleCryptoStreamCipher_) && (INCLUDE_ALL_StreamCipher || defined(INCLUDE_OrgSpongycastleCryptoStreamCipher))
...
#pragma pop_macro("INCLUDE_ALL_StreamCipher")
