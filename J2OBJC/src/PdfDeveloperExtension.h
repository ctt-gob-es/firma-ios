...
#pragma push_macro("INCLUDE_ALL_PdfDeveloperExtension")
#ifdef RESTRICT_PdfDeveloperExtension
#define INCLUDE_ALL_PdfDeveloperExtension 0
#else
#define INCLUDE_ALL_PdfDeveloperExtension 1
#endif
#undef RESTRICT_PdfDeveloperExtension

#if !defined (ComAowagieTextPdfPdfDeveloperExtension_) && (INCLUDE_ALL_PdfDeveloperExtension || defined(INCLUDE_ComAowagieTextPdfPdfDeveloperExtension))
...
#pragma pop_macro("INCLUDE_ALL_PdfDeveloperExtension")
