...
#pragma push_macro("INCLUDE_ALL_Type1Font")
#ifdef RESTRICT_Type1Font
#define INCLUDE_ALL_Type1Font 0
#else
#define INCLUDE_ALL_Type1Font 1
#endif
#undef RESTRICT_Type1Font

#if !defined (ComAowagieTextPdfType1Font_) && (INCLUDE_ALL_Type1Font || defined(INCLUDE_ComAowagieTextPdfType1Font))
...
#pragma pop_macro("INCLUDE_ALL_Type1Font")
