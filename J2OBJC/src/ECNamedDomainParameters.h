...
#pragma push_macro("INCLUDE_ALL_ECNamedDomainParameters")
#ifdef RESTRICT_ECNamedDomainParameters
#define INCLUDE_ALL_ECNamedDomainParameters 0
#else
#define INCLUDE_ALL_ECNamedDomainParameters 1
#endif
#undef RESTRICT_ECNamedDomainParameters

#if !defined (OrgSpongycastleCryptoParamsECNamedDomainParameters_) && (INCLUDE_ALL_ECNamedDomainParameters || defined(INCLUDE_OrgSpongycastleCryptoParamsECNamedDomainParameters))
#define OrgSpongycastleCryptoParamsECNamedDomainParameters_

#define RESTRICT_ECDomainParameters 1
...
#pragma pop_macro("INCLUDE_ALL_ECNamedDomainParameters")
