...
#error "ICC_Profile must be compiled with ARC (-fobjc-arc)"
#endif
...
#line 404
  ComNativeCMM_cmmSetProfileElementWithLong_withInt_withByteArray_(profileHandle_, tagSignature, tagData);
...
- (IOSByteArray *)getDataWithInt:(jint)tagSignature {
  jint tagSize = 0;
  @try {
    tagSize = ComNativeCMM_cmmGetProfileElementSizeWithLong_withInt_(profileHandle_, tagSignature);
  }
  @catch (
#line 415
...
#line 421
  ...
  ComNativeCMM_cmmGetProfileElementWithLong_withInt_withByteArray_(profileHandle_, tagSignature, data);
  return data;
}
...
- (IOSByteArray *)getData {
  jint profileSize = ComNativeCMM_cmmGetProfileSizeWithLong_(profileHandle_);
  IOSByteArray *data = [IOSByteArray newArrayWithLength:profileSize];
  ComNativeCMM_cmmGetProfileWithLong_withByteArray_(profileHandle_, data);
  return data;
}
...
#line 435
  if (profileHandle_ != 0 && !handleStolen_) {
    ComNativeCMM_cmmCloseProfileWithLong_(profileHandle_);
  }
  
#line 441
  ComNativeCMM_removeHandleWithHarmonyJavaAwtColorICC_Profile_(self);
}
...
#line 467
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.15F"));
}
...
#line 525
  @throw new_HarmonyJavaAwtColorProfileDataException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.160"));
}
...
#line 833
  *IOSFloatArray_GetRef(res, 0) = ComICC_ProfileHelper_getIntFromByteArrayWithByteArray_withInt_(data, 0) / 65536.f;
  *IOSFloatArray_GetRef(res, 1) = ComICC_ProfileHelper_getIntFromByteArrayWithByteArray_withInt_(data, 4) / 65536.f;
  *IOSFloatArray_GetRef(res, 2) = ComICC_ProfileHelper_getIntFromByteArrayWithByteArray_withInt_(data, 8) / 65536.f;
...
#line 884
  @throw new_HarmonyJavaAwtColorProfileDataException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.166"));
}
...
#line 894
    @throw new_HarmonyJavaAwtColorProfileDataException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.167"));
  }
  return dataTRC;
}
...
#line 324
  self->profileHandle_ = ComNativeCMM_cmmOpenProfileWithByteArray_(data);
  ComNativeCMM_addHandleWithHarmonyJavaAwtColorICC_Profile_withLong_(self, self->profileHandle_);
}
...
#line 343
  ComNativeCMM_addHandleWithHarmonyJavaAwtColorICC_Profile_withLong_(self, profileHandle);
}
...
#line 603
    @throw new_JavaIoIOException_initWithNSString_(ComMessages_getStringWithNSString_withId_(@"awt.161", fileName));
  }
...
#line 614
  NSString *invalidDataMessage = ComMessages_getStringWithNSString_(@"awt.162");
...
#line 622
  if (ComICC_ProfileHelper_getBigEndianFromByteArrayWithByteArray_withInt_(header, HarmonyJavaAwtColorICC_Profile_icHdrMagic) != HarmonyJavaAwtColorICC_Profile_headerMagicNumber) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(invalidDataMessage);
  }
  
#line 627
  jint profileSize = ComICC_ProfileHelper_getBigEndianFromByteArrayWithByteArray_withInt_(header, HarmonyJavaAwtColorICC_Profile_icHdrSize);
...
#line 648
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.162"));
  }
...
#line 707
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.163"));
  }
  
#line 711
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.164"));
}
...
#line 808
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(ComMessages_getStringWithNSString_(@"awt.165"));
}
...
jint HarmonyJavaAwtColorICC_Profile_getDataSizeWithInt_(HarmonyJavaAwtColorICC_Profile *self, jint tagSignature) {
  return ComNativeCMM_cmmGetProfileElementSizeWithLong_withInt_(self->profileHandle_, tagSignature);
}
...
jfloat HarmonyJavaAwtColorICC_Profile_getGammaOrTRCWithInt_withShortArray_(HarmonyJavaAwtColorICC_Profile *self, jint tagSignature, IOSShortArray *dataTRC) {
  IOSByteArray *data = [self getDataWithInt:tagSignature];
  jint trcSize = ComICC_ProfileHelper_getIntFromByteArrayWithByteArray_withInt_(data, HarmonyJavaAwtColorICC_Profile_icCurveCount);
...
#line 864
    return ComICC_ProfileHelper_getShortFromByteArrayWithByteArray_withInt_(data, HarmonyJavaAwtColorICC_Profile_icCurveData) / 256.f;
  }
...
#line 868
  ...
  for (jint i = 0, pos = HarmonyJavaAwtColorICC_Profile_icCurveData; i < trcSize; i++, pos += 2) {
    *IOSShortArray_GetRef(dataTRC, i) = ComICC_ProfileHelper_getShortFromByteArrayWithByteArray_withInt_(data, pos);
  }
  return 0;
}
...
#line 578
  JavaIoFileInputStream *fiStream = HarmonyJavaAwtColorICC_Profile_tryPathWithNSString_withNSString_(ComUtils_getSystemPropertyWithNSString_(
#line 579
...
#line 585
  fiStream = HarmonyJavaAwtColorICC_Profile_tryPathWithNSString_withNSString_(ComUtils_getSystemPropertyWithNSString_(@"java.class.path"), val$fName_);
  if (fiStream != nil) {
    return JreRetainedLocalValue(fiStream);
  }
  
#line 591
  NSString *home = ComUtils_getSystemPropertyWithNSString_(@"java.home");
  if (home != nil) {
