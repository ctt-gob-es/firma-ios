...
#pragma push_macro("INCLUDE_ALL_FontFactoryImp")
#ifdef RESTRICT_FontFactoryImp
#define INCLUDE_ALL_FontFactoryImp 0
#else
#define INCLUDE_ALL_FontFactoryImp 1
#endif
#undef RESTRICT_FontFactoryImp

#if !defined (ComAowagieTextFontFactoryImp_) && (INCLUDE_ALL_FontFactoryImp || defined(INCLUDE_ComAowagieTextFontFactoryImp))
...
#pragma pop_macro("INCLUDE_ALL_FontFactoryImp")
