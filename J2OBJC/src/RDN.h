...
#pragma push_macro("INCLUDE_ALL_RDN")
#ifdef RESTRICT_RDN
#define INCLUDE_ALL_RDN 0
#else
#define INCLUDE_ALL_RDN 1
#endif
#undef RESTRICT_RDN

#if !defined (OrgSpongycastleAsn1X500RDN_) && (INCLUDE_ALL_RDN || defined(INCLUDE_OrgSpongycastleAsn1X500RDN))
...
#pragma pop_macro("INCLUDE_ALL_RDN")
