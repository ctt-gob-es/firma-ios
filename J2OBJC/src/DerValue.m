...
#line 459
  [((EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *) nil_chk(outArg)) writeWithInt:self->tag_];
...
- (IOSByteArray *)toByteArray {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *out = new_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init();
  
#line 946
  [self encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:out];
  [((EsGobAfirmaCoreSignersDerDerInputStream *) nil_chk(self->data_)) reset];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[20].selector = @selector(encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:);
