...
#pragma push_macro("INCLUDE_ALL_ECFieldElement")
#ifdef RESTRICT_ECFieldElement
#define INCLUDE_ALL_ECFieldElement 0
#else
#define INCLUDE_ALL_ECFieldElement 1
#endif
#undef RESTRICT_ECFieldElement
...
#if !defined (OrgSpongycastleMathEcECFieldElement_) && (INCLUDE_ALL_ECFieldElement || defined(INCLUDE_OrgSpongycastleMathEcECFieldElement))
...
#if !defined (OrgSpongycastleMathEcECFieldElement_Fp_) && (INCLUDE_ALL_ECFieldElement || defined(INCLUDE_OrgSpongycastleMathEcECFieldElement_Fp))
...
#if !defined (OrgSpongycastleMathEcECFieldElement_F2m_) && (INCLUDE_ALL_ECFieldElement || defined(INCLUDE_OrgSpongycastleMathEcECFieldElement_F2m))
...
#pragma pop_macro("INCLUDE_ALL_ECFieldElement")
