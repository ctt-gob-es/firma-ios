...
#pragma push_macro("INCLUDE_ALL_ExceptionConverter")
#ifdef RESTRICT_ExceptionConverter
#define INCLUDE_ALL_ExceptionConverter 0
#else
#define INCLUDE_ALL_ExceptionConverter 1
#endif
#undef RESTRICT_ExceptionConverter

#if !defined (ComAowagieTextExceptionConverter_) && (INCLUDE_ALL_ExceptionConverter || defined(INCLUDE_ComAowagieTextExceptionConverter))
...
#pragma pop_macro("INCLUDE_ALL_ExceptionConverter")
