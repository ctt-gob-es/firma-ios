...
#pragma push_macro("INCLUDE_ALL_MarkedSection")
#ifdef RESTRICT_MarkedSection
#define INCLUDE_ALL_MarkedSection 0
#else
#define INCLUDE_ALL_MarkedSection 1
#endif
#undef RESTRICT_MarkedSection

#if !defined (ComAowagieTextMarkedSection_) && (INCLUDE_ALL_MarkedSection || defined(INCLUDE_ComAowagieTextMarkedSection))
#define ComAowagieTextMarkedSection_

#define RESTRICT_MarkedObject 1
...
#pragma pop_macro("INCLUDE_ALL_MarkedSection")
