...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfFdfReader")
#ifdef RESTRICT_ComAowagieTextPdfFdfReader
#define INCLUDE_ALL_ComAowagieTextPdfFdfReader 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfFdfReader 1
#endif
#undef RESTRICT_ComAowagieTextPdfFdfReader

#if !defined (ComAowagieTextPdfFdfReader_) && (INCLUDE_ALL_ComAowagieTextPdfFdfReader || defined(INCLUDE_ComAowagieTextPdfFdfReader))
#define ComAowagieTextPdfFdfReader_

#define RESTRICT_ComAowagieTextPdfPdfReader 1
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfFdfReader")
