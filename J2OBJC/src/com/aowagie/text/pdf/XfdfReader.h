...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfXfdfReader")
#ifdef RESTRICT_ComAowagieTextPdfXfdfReader
#define INCLUDE_ALL_ComAowagieTextPdfXfdfReader 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfXfdfReader 1
#endif
#undef RESTRICT_ComAowagieTextPdfXfdfReader

#if !defined (ComAowagieTextPdfXfdfReader_) && (INCLUDE_ALL_ComAowagieTextPdfXfdfReader || defined(INCLUDE_ComAowagieTextPdfXfdfReader))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfXfdfReader")
