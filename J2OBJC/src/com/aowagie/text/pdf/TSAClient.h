...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfTSAClient")
#ifdef RESTRICT_ComAowagieTextPdfTSAClient
#define INCLUDE_ALL_ComAowagieTextPdfTSAClient 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfTSAClient 1
#endif
#undef RESTRICT_ComAowagieTextPdfTSAClient

#if !defined (ComAowagieTextPdfTSAClient_) && (INCLUDE_ALL_ComAowagieTextPdfTSAClient || defined(INCLUDE_ComAowagieTextPdfTSAClient))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfTSAClient")
