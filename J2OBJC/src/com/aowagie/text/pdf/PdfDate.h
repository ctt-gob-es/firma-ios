...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfPdfDate")
#ifdef RESTRICT_ComAowagieTextPdfPdfDate
#define INCLUDE_ALL_ComAowagieTextPdfPdfDate 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfPdfDate 1
#endif
#undef RESTRICT_ComAowagieTextPdfPdfDate

#if !defined (ComAowagieTextPdfPdfDate_) && (INCLUDE_ALL_ComAowagieTextPdfPdfDate || defined(INCLUDE_ComAowagieTextPdfPdfDate))
#define ComAowagieTextPdfPdfDate_

#define RESTRICT_ComAowagieTextPdfPdfString 1
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfPdfDate")
