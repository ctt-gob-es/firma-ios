...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfHyphenationByteVector")
#ifdef RESTRICT_ComAowagieTextPdfHyphenationByteVector
#define INCLUDE_ALL_ComAowagieTextPdfHyphenationByteVector 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfHyphenationByteVector 1
#endif
#undef RESTRICT_ComAowagieTextPdfHyphenationByteVector

#if !defined (ComAowagieTextPdfHyphenationByteVector_) && (INCLUDE_ALL_ComAowagieTextPdfHyphenationByteVector || defined(INCLUDE_ComAowagieTextPdfHyphenationByteVector))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfHyphenationByteVector")
