...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfPdfPageEventHelper")
#ifdef RESTRICT_ComAowagieTextPdfPdfPageEventHelper
#define INCLUDE_ALL_ComAowagieTextPdfPdfPageEventHelper 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfPdfPageEventHelper 1
#endif
#undef RESTRICT_ComAowagieTextPdfPdfPageEventHelper

#if !defined (ComAowagieTextPdfPdfPageEventHelper_) && (INCLUDE_ALL_ComAowagieTextPdfPdfPageEventHelper || defined(INCLUDE_ComAowagieTextPdfPdfPageEventHelper))
#define ComAowagieTextPdfPdfPageEventHelper_
...
/*!
 @brief Helps the use of <CODE>PdfPageEvent</CODE> by implementing all the interface methods.
 ...
 */
@interface ComAowagieTextPdfPdfPageEventHelper : NSObject < ComAowagieTextPdfPdfPageEvent >
...
J2OBJC_EMPTY_STATIC_INIT(ComAowagieTextPdfPdfPageEventHelper)

FOUNDATION_EXPORT void ComAowagieTextPdfPdfPageEventHelper_init(ComAowagieTextPdfPdfPageEventHelper *self);

FOUNDATION_EXPORT ComAowagieTextPdfPdfPageEventHelper *new_ComAowagieTextPdfPdfPageEventHelper_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComAowagieTextPdfPdfPageEventHelper *create_ComAowagieTextPdfPdfPageEventHelper_init(void);

J2OBJC_TYPE_LITERAL_HEADER(ComAowagieTextPdfPdfPageEventHelper)

#endif

#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfPdfPageEventHelper")
