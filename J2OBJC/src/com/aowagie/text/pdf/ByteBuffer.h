...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfByteBuffer")
#ifdef RESTRICT_ComAowagieTextPdfByteBuffer
#define INCLUDE_ALL_ComAowagieTextPdfByteBuffer 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfByteBuffer 1
#endif
#undef RESTRICT_ComAowagieTextPdfByteBuffer

#if !defined (ComAowagieTextPdfByteBuffer_) && (INCLUDE_ALL_ComAowagieTextPdfByteBuffer || defined(INCLUDE_ComAowagieTextPdfByteBuffer))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfByteBuffer")
