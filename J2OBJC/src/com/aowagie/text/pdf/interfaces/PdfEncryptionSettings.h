...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfEncryptionSettings")
#ifdef RESTRICT_ComAowagieTextPdfInterfacesPdfEncryptionSettings
#define INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfEncryptionSettings 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfEncryptionSettings 1
#endif
#undef RESTRICT_ComAowagieTextPdfInterfacesPdfEncryptionSettings

#if !defined (ComAowagieTextPdfInterfacesPdfEncryptionSettings_) && (INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfEncryptionSettings || defined(INCLUDE_ComAowagieTextPdfInterfacesPdfEncryptionSettings))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfEncryptionSettings")
