...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfViewerPreferences")
#ifdef RESTRICT_ComAowagieTextPdfInterfacesPdfViewerPreferences
#define INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfViewerPreferences 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfViewerPreferences 1
#endif
#undef RESTRICT_ComAowagieTextPdfInterfacesPdfViewerPreferences

#if !defined (ComAowagieTextPdfInterfacesPdfViewerPreferences_) && (INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfViewerPreferences || defined(INCLUDE_ComAowagieTextPdfInterfacesPdfViewerPreferences))
#define ComAowagieTextPdfInterfacesPdfViewerPreferences_

@class ComAowagieTextPdfPdfName;
@class ComAowagieTextPdfPdfObject;

/*!
 @brief Viewer preferences are described in section 3.6.1 and 8.1 of the
 ...
 */
@protocol ComAowagieTextPdfInterfacesPdfViewerPreferences < JavaObject >

/*!
 @brief Sets the page layout and page mode preferences by ORing one or two of these constants.
 <ul>
...
J2OBJC_EMPTY_STATIC_INIT(ComAowagieTextPdfInterfacesPdfViewerPreferences)

J2OBJC_TYPE_LITERAL_HEADER(ComAowagieTextPdfInterfacesPdfViewerPreferences)

#endif

#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfInterfacesPdfViewerPreferences")
