...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfPushbuttonField")
#ifdef RESTRICT_ComAowagieTextPdfPushbuttonField
#define INCLUDE_ALL_ComAowagieTextPdfPushbuttonField 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfPushbuttonField 1
#endif
#undef RESTRICT_ComAowagieTextPdfPushbuttonField

#if !defined (ComAowagieTextPdfPushbuttonField_) && (INCLUDE_ALL_ComAowagieTextPdfPushbuttonField || defined(INCLUDE_ComAowagieTextPdfPushbuttonField))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfPushbuttonField")
