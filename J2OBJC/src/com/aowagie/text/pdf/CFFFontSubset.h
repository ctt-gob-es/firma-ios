...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfCFFFontSubset")
#ifdef RESTRICT_ComAowagieTextPdfCFFFontSubset
#define INCLUDE_ALL_ComAowagieTextPdfCFFFontSubset 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfCFFFontSubset 1
#endif
#undef RESTRICT_ComAowagieTextPdfCFFFontSubset

#if !defined (ComAowagieTextPdfCFFFontSubset_) && (INCLUDE_ALL_ComAowagieTextPdfCFFFontSubset || defined(INCLUDE_ComAowagieTextPdfCFFFontSubset))
#define ComAowagieTextPdfCFFFontSubset_

#define RESTRICT_ComAowagieTextPdfCFFFont 1
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfCFFFontSubset")
