...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfAcroFields")
#ifdef RESTRICT_ComAowagieTextPdfAcroFields
#define INCLUDE_ALL_ComAowagieTextPdfAcroFields 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfAcroFields 1
#endif
#undef RESTRICT_ComAowagieTextPdfAcroFields

#if !defined (ComAowagieTextPdfAcroFields_) && (INCLUDE_ALL_ComAowagieTextPdfAcroFields || defined(INCLUDE_ComAowagieTextPdfAcroFields))
...
#if !defined (ComAowagieTextPdfAcroFields_Item_) && (INCLUDE_ALL_ComAowagieTextPdfAcroFields || defined(INCLUDE_ComAowagieTextPdfAcroFields_Item))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfAcroFields")
