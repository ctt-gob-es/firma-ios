...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextChunk")
#ifdef RESTRICT_ComAowagieTextChunk
#define INCLUDE_ALL_ComAowagieTextChunk 0
#else
#define INCLUDE_ALL_ComAowagieTextChunk 1
#endif
#undef RESTRICT_ComAowagieTextChunk

#if !defined (ComAowagieTextChunk_) && (INCLUDE_ALL_ComAowagieTextChunk || defined(INCLUDE_ComAowagieTextChunk))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextChunk")
