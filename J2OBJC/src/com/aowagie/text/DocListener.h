...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextDocListener")
#ifdef RESTRICT_ComAowagieTextDocListener
#define INCLUDE_ALL_ComAowagieTextDocListener 0
#else
#define INCLUDE_ALL_ComAowagieTextDocListener 1
#endif
#undef RESTRICT_ComAowagieTextDocListener

#if !defined (ComAowagieTextDocListener_) && (INCLUDE_ALL_ComAowagieTextDocListener || defined(INCLUDE_ComAowagieTextDocListener))
#define ComAowagieTextDocListener_

#define RESTRICT_ComAowagieTextElementListener 1
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextDocListener")
