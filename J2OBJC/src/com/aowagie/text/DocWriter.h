...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextDocWriter")
#ifdef RESTRICT_ComAowagieTextDocWriter
#define INCLUDE_ALL_ComAowagieTextDocWriter 0
#else
#define INCLUDE_ALL_ComAowagieTextDocWriter 1
#endif
#undef RESTRICT_ComAowagieTextDocWriter

#if !defined (ComAowagieTextDocWriter_) && (INCLUDE_ALL_ComAowagieTextDocWriter || defined(INCLUDE_ComAowagieTextDocWriter))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextDocWriter")
