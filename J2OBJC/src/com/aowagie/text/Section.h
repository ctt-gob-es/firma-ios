...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextSection")
#ifdef RESTRICT_ComAowagieTextSection
#define INCLUDE_ALL_ComAowagieTextSection 0
#else
#define INCLUDE_ALL_ComAowagieTextSection 1
#endif
#undef RESTRICT_ComAowagieTextSection

#if !defined (ComAowagieTextSection_) && (INCLUDE_ALL_ComAowagieTextSection || defined(INCLUDE_ComAowagieTextSection))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextSection")
