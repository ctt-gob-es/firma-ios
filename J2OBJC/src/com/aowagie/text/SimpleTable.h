...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextSimpleTable")
#ifdef RESTRICT_ComAowagieTextSimpleTable
#define INCLUDE_ALL_ComAowagieTextSimpleTable 0
#else
#define INCLUDE_ALL_ComAowagieTextSimpleTable 1
#endif
#undef RESTRICT_ComAowagieTextSimpleTable

#if !defined (ComAowagieTextSimpleTable_) && (INCLUDE_ALL_ComAowagieTextSimpleTable || defined(INCLUDE_ComAowagieTextSimpleTable))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextSimpleTable")
