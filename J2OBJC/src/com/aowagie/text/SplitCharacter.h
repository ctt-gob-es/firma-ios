...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextSplitCharacter")
#ifdef RESTRICT_ComAowagieTextSplitCharacter
#define INCLUDE_ALL_ComAowagieTextSplitCharacter 0
#else
#define INCLUDE_ALL_ComAowagieTextSplitCharacter 1
#endif
#undef RESTRICT_ComAowagieTextSplitCharacter

#if !defined (ComAowagieTextSplitCharacter_) && (INCLUDE_ALL_ComAowagieTextSplitCharacter || defined(INCLUDE_ComAowagieTextSplitCharacter))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextSplitCharacter")
