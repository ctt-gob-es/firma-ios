...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextRow")
#ifdef RESTRICT_ComAowagieTextRow
#define INCLUDE_ALL_ComAowagieTextRow 0
#else
#define INCLUDE_ALL_ComAowagieTextRow 1
#endif
#undef RESTRICT_ComAowagieTextRow

#if !defined (ComAowagieTextRow_) && (INCLUDE_ALL_ComAowagieTextRow || defined(INCLUDE_ComAowagieTextRow))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextRow")
