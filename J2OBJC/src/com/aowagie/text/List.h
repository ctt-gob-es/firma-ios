...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextList")
#ifdef RESTRICT_ComAowagieTextList
#define INCLUDE_ALL_ComAowagieTextList 0
#else
#define INCLUDE_ALL_ComAowagieTextList 1
#endif
#undef RESTRICT_ComAowagieTextList

#if !defined (ComAowagieTextList_) && (INCLUDE_ALL_ComAowagieTextList || defined(INCLUDE_ComAowagieTextList))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextList")
