...
#pragma push_macro("INCLUDE_ALL_AOCipherConfig")
#ifdef RESTRICT_AOCipherConfig
#define INCLUDE_ALL_AOCipherConfig 0
#else
#define INCLUDE_ALL_AOCipherConfig 1
#endif
#undef RESTRICT_AOCipherConfig

#if !defined (EsGobAfirmaCoreCiphersAOCipherConfig_) && (INCLUDE_ALL_AOCipherConfig || defined(INCLUDE_EsGobAfirmaCoreCiphersAOCipherConfig))
...
#pragma pop_macro("INCLUDE_ALL_AOCipherConfig")
