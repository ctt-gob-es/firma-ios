...
#pragma push_macro("INCLUDE_ALL_AOTreeNode")
#ifdef RESTRICT_AOTreeNode
#define INCLUDE_ALL_AOTreeNode 0
#else
#define INCLUDE_ALL_AOTreeNode 1
#endif
#undef RESTRICT_AOTreeNode

#if !defined (EsGobAfirmaCoreUtilTreeAOTreeNode_) && (INCLUDE_ALL_AOTreeNode || defined(INCLUDE_EsGobAfirmaCoreUtilTreeAOTreeNode))
...
#pragma pop_macro("INCLUDE_ALL_AOTreeNode")
