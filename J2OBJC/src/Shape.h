...
#pragma push_macro("INCLUDE_ALL_Shape")
#ifdef RESTRICT_Shape
#define INCLUDE_ALL_Shape 0
#else
#define INCLUDE_ALL_Shape 1
#endif
#undef RESTRICT_Shape

#if !defined (HarmonyJavaAwtShape_) && (INCLUDE_ALL_Shape || defined(INCLUDE_HarmonyJavaAwtShape))
...
#pragma pop_macro("INCLUDE_ALL_Shape")
