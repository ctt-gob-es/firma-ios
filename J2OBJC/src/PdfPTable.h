...
#pragma push_macro("INCLUDE_ALL_PdfPTable")
#ifdef RESTRICT_PdfPTable
#define INCLUDE_ALL_PdfPTable 0
#else
#define INCLUDE_ALL_PdfPTable 1
#endif
#undef RESTRICT_PdfPTable

#if !defined (ComAowagieTextPdfPdfPTable_) && (INCLUDE_ALL_PdfPTable || defined(INCLUDE_ComAowagieTextPdfPdfPTable))
...
#pragma pop_macro("INCLUDE_ALL_PdfPTable")
