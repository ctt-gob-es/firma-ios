...
#pragma push_macro("INCLUDE_ALL_Nat320")
#ifdef RESTRICT_Nat320
#define INCLUDE_ALL_Nat320 0
#else
#define INCLUDE_ALL_Nat320 1
#endif
#undef RESTRICT_Nat320

#if !defined (OrgSpongycastleMathRawNat320_) && (INCLUDE_ALL_Nat320 || defined(INCLUDE_OrgSpongycastleMathRawNat320))
...
#pragma pop_macro("INCLUDE_ALL_Nat320")
