...
#pragma push_macro("INCLUDE_ALL_AOSigner")
#ifdef RESTRICT_AOSigner
#define INCLUDE_ALL_AOSigner 0
#else
#define INCLUDE_ALL_AOSigner 1
#endif
#undef RESTRICT_AOSigner

#if !defined (EsGobAfirmaCoreSignersAOSigner_) && (INCLUDE_ALL_AOSigner || defined(INCLUDE_EsGobAfirmaCoreSignersAOSigner))
#define EsGobAfirmaCoreSignersAOSigner_

#define RESTRICT_AOCoSigner 1
#define INCLUDE_EsGobAfirmaCoreSignersAOCoSigner 1
#include "AOCoSigner.h"

#define RESTRICT_AOCounterSigner 1
#define INCLUDE_EsGobAfirmaCoreSignersAOCounterSigner 1
#include "AOCounterSigner.h"

#define RESTRICT_AOSimpleSigner 1
...
#pragma pop_macro("INCLUDE_ALL_AOSigner")
