...
#pragma push_macro("INCLUDE_ALL_NISTNamedCurves")
#ifdef RESTRICT_NISTNamedCurves
#define INCLUDE_ALL_NISTNamedCurves 0
#else
#define INCLUDE_ALL_NISTNamedCurves 1
#endif
#undef RESTRICT_NISTNamedCurves

#if !defined (OrgSpongycastleAsn1NistNISTNamedCurves_) && (INCLUDE_ALL_NISTNamedCurves || defined(INCLUDE_OrgSpongycastleAsn1NistNISTNamedCurves))
...
#pragma pop_macro("INCLUDE_ALL_NISTNamedCurves")
