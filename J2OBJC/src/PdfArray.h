...
#pragma push_macro("INCLUDE_ALL_PdfArray")
#ifdef RESTRICT_PdfArray
#define INCLUDE_ALL_PdfArray 0
#else
#define INCLUDE_ALL_PdfArray 1
#endif
#undef RESTRICT_PdfArray

#if !defined (ComAowagieTextPdfPdfArray_) && (INCLUDE_ALL_PdfArray || defined(INCLUDE_ComAowagieTextPdfPdfArray))
...
#pragma pop_macro("INCLUDE_ALL_PdfArray")
