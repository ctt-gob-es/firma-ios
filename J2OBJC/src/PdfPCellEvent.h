...
#pragma push_macro("INCLUDE_ALL_PdfPCellEvent")
#ifdef RESTRICT_PdfPCellEvent
#define INCLUDE_ALL_PdfPCellEvent 0
#else
#define INCLUDE_ALL_PdfPCellEvent 1
#endif
#undef RESTRICT_PdfPCellEvent

#if !defined (ComAowagieTextPdfPdfPCellEvent_) && (INCLUDE_ALL_PdfPCellEvent || defined(INCLUDE_ComAowagieTextPdfPdfPCellEvent))
...
#pragma pop_macro("INCLUDE_ALL_PdfPCellEvent")
