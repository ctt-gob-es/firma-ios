...
#pragma push_macro("INCLUDE_ALL_GeneralPath")
#ifdef RESTRICT_GeneralPath
#define INCLUDE_ALL_GeneralPath 0
#else
#define INCLUDE_ALL_GeneralPath 1
#endif
#undef RESTRICT_GeneralPath

#if !defined (HarmonyJavaAwtGeomGeneralPath_) && (INCLUDE_ALL_GeneralPath || defined(INCLUDE_HarmonyJavaAwtGeomGeneralPath))
...
#if !defined (HarmonyJavaAwtGeomGeneralPath_Iterator_) && (INCLUDE_ALL_GeneralPath || defined(INCLUDE_HarmonyJavaAwtGeomGeneralPath_Iterator))
...
#pragma pop_macro("INCLUDE_ALL_GeneralPath")
