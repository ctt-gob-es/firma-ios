...
#pragma push_macro("INCLUDE_ALL_PdfPageEventHelper")
#ifdef RESTRICT_PdfPageEventHelper
#define INCLUDE_ALL_PdfPageEventHelper 0
#else
#define INCLUDE_ALL_PdfPageEventHelper 1
#endif
#undef RESTRICT_PdfPageEventHelper

#if !defined (ComAowagieTextPdfPdfPageEventHelper_) && (INCLUDE_ALL_PdfPageEventHelper || defined(INCLUDE_ComAowagieTextPdfPdfPageEventHelper))
#define ComAowagieTextPdfPdfPageEventHelper_

#define RESTRICT_PdfPageEvent 1
...
#pragma pop_macro("INCLUDE_ALL_PdfPageEventHelper")
