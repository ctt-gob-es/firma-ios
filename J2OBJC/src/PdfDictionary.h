...
#pragma push_macro("INCLUDE_ALL_PdfDictionary")
#ifdef RESTRICT_PdfDictionary
#define INCLUDE_ALL_PdfDictionary 0
#else
#define INCLUDE_ALL_PdfDictionary 1
#endif
#undef RESTRICT_PdfDictionary

#if !defined (ComAowagieTextPdfPdfDictionary_) && (INCLUDE_ALL_PdfDictionary || defined(INCLUDE_ComAowagieTextPdfPdfDictionary))
...
#pragma pop_macro("INCLUDE_ALL_PdfDictionary")
