...
#pragma push_macro("INCLUDE_ALL_PdfPageEventForwarder")
#ifdef RESTRICT_PdfPageEventForwarder
#define INCLUDE_ALL_PdfPageEventForwarder 0
#else
#define INCLUDE_ALL_PdfPageEventForwarder 1
#endif
#undef RESTRICT_PdfPageEventForwarder

#if !defined (ComAowagieTextPdfEventsPdfPageEventForwarder_) && (INCLUDE_ALL_PdfPageEventForwarder || defined(INCLUDE_ComAowagieTextPdfEventsPdfPageEventForwarder))
...
#pragma pop_macro("INCLUDE_ALL_PdfPageEventForwarder")
