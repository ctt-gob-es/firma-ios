...
#pragma push_macro("INCLUDE_ALL_ITextBase64")
#ifdef RESTRICT_ITextBase64
#define INCLUDE_ALL_ITextBase64 0
#else
#define INCLUDE_ALL_ITextBase64 1
#endif
#undef RESTRICT_ITextBase64

#if !defined (ComAowagieTextPdfCodecITextBase64_) && (INCLUDE_ALL_ITextBase64 || defined(INCLUDE_ComAowagieTextPdfCodecITextBase64))
...
#pragma pop_macro("INCLUDE_ALL_ITextBase64")
