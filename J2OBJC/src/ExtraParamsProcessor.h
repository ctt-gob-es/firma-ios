...
#pragma push_macro("INCLUDE_ALL_ExtraParamsProcessor")
#ifdef RESTRICT_ExtraParamsProcessor
#define INCLUDE_ALL_ExtraParamsProcessor 0
#else
#define INCLUDE_ALL_ExtraParamsProcessor 1
#endif
#undef RESTRICT_ExtraParamsProcessor

#if !defined (EsGobAfirmaCoreSignersExtraParamsProcessor_) && (INCLUDE_ALL_ExtraParamsProcessor || defined(INCLUDE_EsGobAfirmaCoreSignersExtraParamsProcessor))
...
#if !defined (EsGobAfirmaCoreSignersExtraParamsProcessor_IncompatiblePolicyException_) && (INCLUDE_ALL_ExtraParamsProcessor || defined(INCLUDE_EsGobAfirmaCoreSignersExtraParamsProcessor_IncompatiblePolicyException))
...
#pragma pop_macro("INCLUDE_ALL_ExtraParamsProcessor")
