...
//  source: /Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/es/gob/afirma/core/signers/der/DerOutputStreamRenamed.java
//
...
#error "DerOutputStreamRenamed must be compiled with ARC (-fobjc-arc)"
#endif

@interface EsGobAfirmaCoreSignersDerDerOutputStreamRenamed ()
 ...
 */
inline EsGobAfirmaCoreSignersDerByteArrayLexOrder *EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_get_lexOrder(void);
inline EsGobAfirmaCoreSignersDerByteArrayLexOrder *EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_set_lexOrder(EsGobAfirmaCoreSignersDerByteArrayLexOrder *value);
static EsGobAfirmaCoreSignersDerByteArrayLexOrder *EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_lexOrder;
J2OBJC_STATIC_FIELD_OBJ(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed, lexOrder, EsGobAfirmaCoreSignersDerByteArrayLexOrder *)

/*!
 @brief Tag order comparison on byte arrays, for ordering elements of
   SET objects in DER encoding.
 */
inline EsGobAfirmaCoreSignersDerByteArrayTagOrder *EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_get_tagOrder(void);
inline EsGobAfirmaCoreSignersDerByteArrayTagOrder *EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_set_tagOrder(EsGobAfirmaCoreSignersDerByteArrayTagOrder *value);
static EsGobAfirmaCoreSignersDerByteArrayTagOrder *EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_tagOrder;
J2OBJC_STATIC_FIELD_OBJ(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed, tagOrder, EsGobAfirmaCoreSignersDerByteArrayTagOrder *)

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putIntegerContentsWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, jint i);

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, jbyte tag, IOSObjectArray *set, id<JavaUtilComparator> order);

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, NSString *s, jbyte stringTag, NSString *enc);

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putTimeWithJavaUtilDate_withByte_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, JavaUtilDate *d, jbyte tag);

#line 1 "/Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/es/gob/afirma/core/signers/der/DerOutputStreamRenamed.java"

J2OBJC_INITIALIZED_DEFN(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed)


#line 54
@implementation EsGobAfirmaCoreSignersDerDerOutputStreamRenamed


#line 61
- (instancetype)initWithInt:(jint)size {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(self, size);
  return self;
}
...
#line 66
- (instancetype)init {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init(self);
  return self;
}
...
#line 94
- (void)writeWithByte:(jbyte)tag
withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *)outArg {
  
#line 95
  [self writeWithInt:tag];
  [self putLengthWithInt:((EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *) nil_chk(outArg))->count_];
...
withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *)value {
  [self writeWithInt:tag];
  [self writeWithByteArray:((EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *) nil_chk(value))->buf_ withInt:1 withInt:value->count_ - 1];
}


#line 129
- (void)putDerValueWithEsGobAfirmaCoreSignersDerDerValue:(EsGobAfirmaCoreSignersDerDerValue *)val {
  [((EsGobAfirmaCoreSignersDerDerValue *) nil_chk(val)) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:self];
}
...
- (void)putEnumeratedWithInt:(jint)i {
  ...
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putIntegerContentsWithInt_(self, i);
}
...
- (void)putOIDWithEsGobAfirmaCoreSignersDerObjectIdentifier:(EsGobAfirmaCoreSignersDerObjectIdentifier *)oid {
  [((EsGobAfirmaCoreSignersDerObjectIdentifier *) nil_chk(oid)) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:self];
}


#line 323
- (void)putSequenceWithEsGobAfirmaCoreSignersDerDerValueArray:(IOSObjectArray *)seq {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *bytes = new_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init();
  jint i;
  
#line 327
  for (i = 0; i < ((IOSObjectArray *) nil_chk(seq))->size_; i++) {
    [((EsGobAfirmaCoreSignersDerDerValue *) nil_chk(IOSObjectArray_Get(seq, i))) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:bytes];
  }
  
#line 331
  [self writeWithByte:EsGobAfirmaCoreSignersDerDerValue_tag_Sequence withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:bytes];
}
...
#line 347
  for (i = 0; i < ((IOSObjectArray *) nil_chk(set))->size_; i++) {
    [((EsGobAfirmaCoreSignersDerDerValue *) nil_chk(IOSObjectArray_Get(set, i))) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:bytes];
  }
  
#line 351
  [self writeWithByte:EsGobAfirmaCoreSignersDerDerValue_tag_Set withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:bytes];
}
...
#line 368
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(self, tag, set, EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_lexOrder);
}
...
#line 385
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(self, tag, set, EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_tagOrder);
}
...
withEsGobAfirmaCoreSignersDerDerEncoderArray:(IOSObjectArray *)set
       withJavaUtilComparator:(id<JavaUtilComparator>)order {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(self, tag, set, order);
}


#line 437
- (void)putUTF8StringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_UTF8String, @"UTF8");
}


#line 446
- (void)putPrintableStringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_PrintableString, @"ASCII");
}
...
#line 460
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_T61String, @"ISO-8859-1");
}


#line 468
- (void)putIA5StringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_IA5String, @"ASCII");
}


#line 477
- (void)putBMPStringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_BMPString, @"UnicodeBigUnmarked");
}


#line 486
- (void)putGeneralStringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_GeneralString, @"ASCII");
}
...
- (void)writeStringWithNSString:(NSString *)s
                       withByte:(jbyte)stringTag
                   withNSString:(NSString *)enc {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(self, s, stringTag, enc);
}


#line 516
- (void)putUTCTimeWithJavaUtilDate:(JavaUtilDate *)d {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putTimeWithJavaUtilDate_withByte_(self, d, EsGobAfirmaCoreSignersDerDerValue_tag_UtcTime);
}


#line 528
- (void)putGeneralizedTimeWithJavaUtilDate:(JavaUtilDate *)d {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putTimeWithJavaUtilDate_withByte_(self, d, EsGobAfirmaCoreSignersDerDerValue_tag_GeneralizedTime);
}
...
- (void)putTimeWithJavaUtilDate:(JavaUtilDate *)d
                       withByte:(jbyte)tag {
  EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putTimeWithJavaUtilDate_withByte_(self, d, tag);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(writeWithByte:withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:);
  methods[4].selector = @selector(writeImplicitWithByte:withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:);
  ...
  static const void *ptrTable[] = { "I", "write", "B[B", "LJavaIoIOException;", "BLEsGobAfirmaCoreSignersDerDerOutputStreamRenamed;", "writeImplicit", "putDerValue", "LEsGobAfirmaCoreSignersDerDerValue;", "putBoolean", "Z", "putEnumerated", "putInteger", "LJavaMathBigInteger;", "LJavaLangInteger;", "putIntegerContents", "putBitString", "[B", "putUnalignedBitString", "LEsGobAfirmaCoreSignersDerBitArray;", "putTruncatedUnalignedBitString", "putOctetString", "putOID", "LEsGobAfirmaCoreSignersDerObjectIdentifier;", "putSequence", "[LEsGobAfirmaCoreSignersDerDerValue;", "putSet", "putOrderedSetOf", "B[LEsGobAfirmaCoreSignersDerDerEncoder;", "putOrderedSet", "B[LEsGobAfirmaCoreSignersDerDerEncoder;LJavaUtilComparator;", "(B[Les/gob/afirma/core/signers/der/DerEncoder;Ljava/util/Comparator<[B>;)V", "putUTF8String", "LNSString;", "putPrintableString", "putT61String", "putIA5String", "putBMPString", "putGeneralString", "writeString", "LNSString;BLNSString;", "putUTCTime", "LJavaUtilDate;", "putGeneralizedTime", "putTime", "LJavaUtilDate;B", "putLength", "putTag", "BZB", "derEncode", "LJavaIoOutputStream;", &EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_lexOrder, &EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_tagOrder };
  static const J2ObjcClassInfo _EsGobAfirmaCoreSignersDerDerOutputStreamRenamed = { "DerOutputStreamRenamed", "es.gob.afirma.core.signers.der", ptrTable, methods, fields, 7, 0x1, 36, 2, -1, -1, -1, -1, -1 };
  return &_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed;
}

+ (void)initialize {
  if (self == [EsGobAfirmaCoreSignersDerDerOutputStreamRenamed class]) {
    EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_lexOrder = new_EsGobAfirmaCoreSignersDerByteArrayLexOrder_init();
    EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_tagOrder = new_EsGobAfirmaCoreSignersDerByteArrayTagOrder_init();
    J2OBJC_SET_INITIALIZED(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed)
  }
}
...
#line 61
void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, jint size) {
...
#line 61
EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *new_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(jint size) {
  J2OBJC_NEW_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed, initWithInt_, size)
}


#line 61
EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *create_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_initWithInt_(jint size) {
  J2OBJC_CREATE_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed, initWithInt_, size)
}


#line 66
void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self) {
  JavaIoByteArrayOutputStream_init(self);
}


#line 66
EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *new_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init() {
  J2OBJC_NEW_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed, init)
}


#line 66
EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *create_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init() {
  J2OBJC_CREATE_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed, init)
}


#line 198
void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putIntegerContentsWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, jint i) {
...
#line 408
void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, jbyte tag, IOSObjectArray *set, id<JavaUtilComparator> order) {
  
#line 410
  IOSObjectArray *streams = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(set))->size_ type:EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_class_()];
  
#line 412
  for (jint i = 0; i < set->size_; i++) {
    (void) IOSObjectArray_SetAndConsume(streams, i, new_EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_init());
...
#line 418
  ...
  for (jint i = 0; i < streams->size_; i++) {
    (void) IOSObjectArray_Set(bufs, i, [((EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *) nil_chk(IOSObjectArray_Get(streams, i))) toByteArray]);
  }
...
#line 424
  ...
  [self writeWithByte:tag withEsGobAfirmaCoreSignersDerDerOutputStreamRenamed:bytes];
}


#line 499
void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_writeStringWithNSString_withByte_withNSString_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, NSString *s, jbyte stringTag, NSString *enc) {
...
#line 540
void EsGobAfirmaCoreSignersDerDerOutputStreamRenamed_putTimeWithJavaUtilDate_withByte_(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed *self, JavaUtilDate *d, jbyte tag) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(EsGobAfirmaCoreSignersDerDerOutputStreamRenamed)
