...
#pragma push_macro("INCLUDE_ALL_Holder")
#ifdef RESTRICT_Holder
#define INCLUDE_ALL_Holder 0
#else
#define INCLUDE_ALL_Holder 1
#endif
#undef RESTRICT_Holder

#if !defined (OrgSpongycastleAsn1X509Holder_) && (INCLUDE_ALL_Holder || defined(INCLUDE_OrgSpongycastleAsn1X509Holder))
...
#pragma pop_macro("INCLUDE_ALL_Holder")
