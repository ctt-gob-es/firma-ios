...
#pragma push_macro("INCLUDE_ALL_EncoderException")
#ifdef RESTRICT_EncoderException
#define INCLUDE_ALL_EncoderException 0
#else
#define INCLUDE_ALL_EncoderException 1
#endif
#undef RESTRICT_EncoderException

#if !defined (OrgSpongycastleUtilEncodersEncoderException_) && (INCLUDE_ALL_EncoderException || defined(INCLUDE_OrgSpongycastleUtilEncodersEncoderException))
...
#pragma pop_macro("INCLUDE_ALL_EncoderException")
