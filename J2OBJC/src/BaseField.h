...
#pragma push_macro("INCLUDE_ALL_BaseField")
#ifdef RESTRICT_BaseField
#define INCLUDE_ALL_BaseField 0
#else
#define INCLUDE_ALL_BaseField 1
#endif
#undef RESTRICT_BaseField

#if !defined (ComAowagieTextPdfBaseField_) && (INCLUDE_ALL_BaseField || defined(INCLUDE_ComAowagieTextPdfBaseField))
...
#pragma pop_macro("INCLUDE_ALL_BaseField")
