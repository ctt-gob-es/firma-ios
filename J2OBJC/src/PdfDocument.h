...
//  source: /Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/com/aowagie/text/pdf/PdfDocument.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_PdfDocument")
#ifdef RESTRICT_PdfDocument
#define INCLUDE_ALL_PdfDocument 0
#else
#define INCLUDE_ALL_PdfDocument 1
#endif
#undef RESTRICT_PdfDocument

#if !defined (ComAowagieTextPdfPdfDocument_) && (INCLUDE_ALL_PdfDocument || defined(INCLUDE_ComAowagieTextPdfPdfDocument))
#define ComAowagieTextPdfPdfDocument_

#define RESTRICT_Document 1
...
#if !defined (ComAowagieTextPdfPdfDocument_PdfInfo_) && (INCLUDE_ALL_PdfDocument || defined(INCLUDE_ComAowagieTextPdfPdfDocument_PdfInfo))
...
#if !defined (ComAowagieTextPdfPdfDocument_PdfCatalog_) && (INCLUDE_ALL_PdfDocument || defined(INCLUDE_ComAowagieTextPdfPdfDocument_PdfCatalog))
...
#pragma pop_macro("INCLUDE_ALL_PdfDocument")
