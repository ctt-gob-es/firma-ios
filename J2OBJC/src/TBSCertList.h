...
#pragma push_macro("INCLUDE_ALL_TBSCertList")
#ifdef RESTRICT_TBSCertList
#define INCLUDE_ALL_TBSCertList 0
#else
#define INCLUDE_ALL_TBSCertList 1
#endif
#undef RESTRICT_TBSCertList

#if !defined (OrgSpongycastleAsn1X509TBSCertList_) && (INCLUDE_ALL_TBSCertList || defined(INCLUDE_OrgSpongycastleAsn1X509TBSCertList))
...
#if !defined (OrgSpongycastleAsn1X509TBSCertList_CRLEntry_) && (INCLUDE_ALL_TBSCertList || defined(INCLUDE_OrgSpongycastleAsn1X509TBSCertList_CRLEntry))
...
#pragma pop_macro("INCLUDE_ALL_TBSCertList")
