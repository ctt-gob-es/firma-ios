...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleCmsSignerInformation")
#ifdef RESTRICT_OrgSpongycastleCmsSignerInformation
#define INCLUDE_ALL_OrgSpongycastleCmsSignerInformation 0
#else
#define INCLUDE_ALL_OrgSpongycastleCmsSignerInformation 1
#endif
#undef RESTRICT_OrgSpongycastleCmsSignerInformation

#if !defined (OrgSpongycastleCmsSignerInformation_) && (INCLUDE_ALL_OrgSpongycastleCmsSignerInformation || defined(INCLUDE_OrgSpongycastleCmsSignerInformation))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleCmsSignerInformation")
