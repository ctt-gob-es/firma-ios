...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleUtilStrings")
#ifdef RESTRICT_OrgSpongycastleUtilStrings
#define INCLUDE_ALL_OrgSpongycastleUtilStrings 0
#else
#define INCLUDE_ALL_OrgSpongycastleUtilStrings 1
#endif
#undef RESTRICT_OrgSpongycastleUtilStrings

#if !defined (OrgSpongycastleUtilStrings_) && (INCLUDE_ALL_OrgSpongycastleUtilStrings || defined(INCLUDE_OrgSpongycastleUtilStrings))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleUtilStrings")
