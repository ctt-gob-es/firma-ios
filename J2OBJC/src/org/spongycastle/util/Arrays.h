...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleUtilArrays")
#ifdef RESTRICT_OrgSpongycastleUtilArrays
#define INCLUDE_ALL_OrgSpongycastleUtilArrays 0
#else
#define INCLUDE_ALL_OrgSpongycastleUtilArrays 1
#endif
#undef RESTRICT_OrgSpongycastleUtilArrays

#if !defined (OrgSpongycastleUtilArrays_) && (INCLUDE_ALL_OrgSpongycastleUtilArrays || defined(INCLUDE_OrgSpongycastleUtilArrays))
...
#if !defined (OrgSpongycastleUtilArrays_Iterator_) && (INCLUDE_ALL_OrgSpongycastleUtilArrays || defined(INCLUDE_OrgSpongycastleUtilArrays_Iterator))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleUtilArrays")
