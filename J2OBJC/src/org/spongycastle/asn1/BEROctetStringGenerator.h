...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1BEROctetStringGenerator")
#ifdef RESTRICT_OrgSpongycastleAsn1BEROctetStringGenerator
#define INCLUDE_ALL_OrgSpongycastleAsn1BEROctetStringGenerator 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1BEROctetStringGenerator 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1BEROctetStringGenerator

#if !defined (OrgSpongycastleAsn1BEROctetStringGenerator_) && (INCLUDE_ALL_OrgSpongycastleAsn1BEROctetStringGenerator || defined(INCLUDE_OrgSpongycastleAsn1BEROctetStringGenerator))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1BEROctetStringGenerator")
