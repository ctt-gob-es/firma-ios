...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1MiscNetscapeCertType")
#ifdef RESTRICT_OrgSpongycastleAsn1MiscNetscapeCertType
#define INCLUDE_ALL_OrgSpongycastleAsn1MiscNetscapeCertType 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1MiscNetscapeCertType 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1MiscNetscapeCertType

#if !defined (OrgSpongycastleAsn1MiscNetscapeCertType_) && (INCLUDE_ALL_OrgSpongycastleAsn1MiscNetscapeCertType || defined(INCLUDE_OrgSpongycastleAsn1MiscNetscapeCertType))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1MiscNetscapeCertType")
