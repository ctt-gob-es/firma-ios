...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1X509CertificateList")
#ifdef RESTRICT_OrgSpongycastleAsn1X509CertificateList
#define INCLUDE_ALL_OrgSpongycastleAsn1X509CertificateList 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1X509CertificateList 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1X509CertificateList

#if !defined (OrgSpongycastleAsn1X509CertificateList_) && (INCLUDE_ALL_OrgSpongycastleAsn1X509CertificateList || defined(INCLUDE_OrgSpongycastleAsn1X509CertificateList))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1X509CertificateList")
