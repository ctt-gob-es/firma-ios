...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1AnssiANSSINamedCurves")
#ifdef RESTRICT_OrgSpongycastleAsn1AnssiANSSINamedCurves
#define INCLUDE_ALL_OrgSpongycastleAsn1AnssiANSSINamedCurves 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1AnssiANSSINamedCurves 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1AnssiANSSINamedCurves

#if !defined (OrgSpongycastleAsn1AnssiANSSINamedCurves_) && (INCLUDE_ALL_OrgSpongycastleAsn1AnssiANSSINamedCurves || defined(INCLUDE_OrgSpongycastleAsn1AnssiANSSINamedCurves))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1AnssiANSSINamedCurves")
