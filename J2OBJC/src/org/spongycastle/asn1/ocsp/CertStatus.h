...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1OcspCertStatus")
#ifdef RESTRICT_OrgSpongycastleAsn1OcspCertStatus
#define INCLUDE_ALL_OrgSpongycastleAsn1OcspCertStatus 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1OcspCertStatus 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1OcspCertStatus

#if !defined (OrgSpongycastleAsn1OcspCertStatus_) && (INCLUDE_ALL_OrgSpongycastleAsn1OcspCertStatus || defined(INCLUDE_OrgSpongycastleAsn1OcspCertStatus))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1OcspCertStatus")
