...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1EssESSCertIDv2")
#ifdef RESTRICT_OrgSpongycastleAsn1EssESSCertIDv2
#define INCLUDE_ALL_OrgSpongycastleAsn1EssESSCertIDv2 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1EssESSCertIDv2 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1EssESSCertIDv2

#if !defined (OrgSpongycastleAsn1EssESSCertIDv2_) && (INCLUDE_ALL_OrgSpongycastleAsn1EssESSCertIDv2 || defined(INCLUDE_OrgSpongycastleAsn1EssESSCertIDv2))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1EssESSCertIDv2")
