...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleOperatorSecretKeySizeProvider")
#ifdef RESTRICT_OrgSpongycastleOperatorSecretKeySizeProvider
#define INCLUDE_ALL_OrgSpongycastleOperatorSecretKeySizeProvider 0
#else
#define INCLUDE_ALL_OrgSpongycastleOperatorSecretKeySizeProvider 1
#endif
#undef RESTRICT_OrgSpongycastleOperatorSecretKeySizeProvider

#if !defined (OrgSpongycastleOperatorSecretKeySizeProvider_) && (INCLUDE_ALL_OrgSpongycastleOperatorSecretKeySizeProvider || defined(INCLUDE_OrgSpongycastleOperatorSecretKeySizeProvider))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleOperatorSecretKeySizeProvider")
