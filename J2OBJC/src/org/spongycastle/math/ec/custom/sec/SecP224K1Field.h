...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleMathEcCustomSecSecP224K1Field")
#ifdef RESTRICT_OrgSpongycastleMathEcCustomSecSecP224K1Field
#define INCLUDE_ALL_OrgSpongycastleMathEcCustomSecSecP224K1Field 0
#else
#define INCLUDE_ALL_OrgSpongycastleMathEcCustomSecSecP224K1Field 1
#endif
#undef RESTRICT_OrgSpongycastleMathEcCustomSecSecP224K1Field

#if !defined (OrgSpongycastleMathEcCustomSecSecP224K1Field_) && (INCLUDE_ALL_OrgSpongycastleMathEcCustomSecSecP224K1Field || defined(INCLUDE_OrgSpongycastleMathEcCustomSecSecP224K1Field))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleMathEcCustomSecSecP224K1Field")
