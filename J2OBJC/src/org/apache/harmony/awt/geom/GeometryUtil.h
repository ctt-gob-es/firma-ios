...
#pragma push_macro("INCLUDE_ALL_OrgApacheHarmonyAwtGeomGeometryUtil")
#ifdef RESTRICT_OrgApacheHarmonyAwtGeomGeometryUtil
#define INCLUDE_ALL_OrgApacheHarmonyAwtGeomGeometryUtil 0
#else
#define INCLUDE_ALL_OrgApacheHarmonyAwtGeomGeometryUtil 1
#endif
#undef RESTRICT_OrgApacheHarmonyAwtGeomGeometryUtil

#if !defined (OrgApacheHarmonyAwtGeomGeometryUtil_) && (INCLUDE_ALL_OrgApacheHarmonyAwtGeomGeometryUtil || defined(INCLUDE_OrgApacheHarmonyAwtGeomGeometryUtil))
#define OrgApacheHarmonyAwtGeomGeometryUtil_

@class IOSDoubleArray;

@interface OrgApacheHarmonyAwtGeomGeometryUtil : NSObject
...
J2OBJC_STATIC_INIT(OrgApacheHarmonyAwtGeomGeometryUtil)

inline jdouble OrgApacheHarmonyAwtGeomGeometryUtil_get_EPSILON(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT jdouble OrgApacheHarmonyAwtGeomGeometryUtil_EPSILON;
J2OBJC_STATIC_FIELD_PRIMITIVE_FINAL(OrgApacheHarmonyAwtGeomGeometryUtil, EPSILON, jdouble)

FOUNDATION_EXPORT void OrgApacheHarmonyAwtGeomGeometryUtil_init(OrgApacheHarmonyAwtGeomGeometryUtil *self);

FOUNDATION_EXPORT OrgApacheHarmonyAwtGeomGeometryUtil *new_OrgApacheHarmonyAwtGeomGeometryUtil_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheHarmonyAwtGeomGeometryUtil *create_OrgApacheHarmonyAwtGeomGeometryUtil_init(void);

FOUNDATION_EXPORT jint OrgApacheHarmonyAwtGeomGeometryUtil_intersectLinesWithParamsWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(jdouble x1, jdouble y1, jdouble x2, jdouble y2, jdouble x3, jdouble y3, jdouble x4, jdouble y4, IOSDoubleArray *params);

FOUNDATION_EXPORT jint OrgApacheHarmonyAwtGeomGeometryUtil_intersectLinesWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(jdouble x1, jdouble y1, jdouble x2, jdouble y2, jdouble x3, jdouble y3, jdouble x4, jdouble y4, IOSDoubleArray *point);
...
FOUNDATION_EXPORT jdouble OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(jdouble t, jdouble x1, jdouble x2);

FOUNDATION_EXPORT jdouble OrgApacheHarmonyAwtGeomGeometryUtil_quadWithDouble_withDouble_withDouble_withDouble_(jdouble t, jdouble x1, jdouble x2, jdouble x3);

FOUNDATION_EXPORT jdouble OrgApacheHarmonyAwtGeomGeometryUtil_cubicWithDouble_withDouble_withDouble_withDouble_withDouble_(jdouble t, jdouble x1, jdouble x2, jdouble x3, jdouble x4);

FOUNDATION_EXPORT void OrgApacheHarmonyAwtGeomGeometryUtil_subQuadWithDoubleArray_withDouble_withBoolean_(IOSDoubleArray *coef, jdouble t0, jboolean left);

FOUNDATION_EXPORT void OrgApacheHarmonyAwtGeomGeometryUtil_subCubicWithDoubleArray_withDouble_withBoolean_(IOSDoubleArray *coef, jdouble t0, jboolean left);

J2OBJC_TYPE_LITERAL_HEADER(OrgApacheHarmonyAwtGeomGeometryUtil)

#endif

#pragma pop_macro("INCLUDE_ALL_OrgApacheHarmonyAwtGeomGeometryUtil")
