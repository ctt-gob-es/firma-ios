...
#error "DerOutputStreamJ2OBJC must be compiled with ARC (-fobjc-arc)"
#endif

@interface EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC ()
 ...
 */
inline EsGobAfirmaCoreSignersDerByteArrayLexOrder *EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_get_lexOrder(void);
inline EsGobAfirmaCoreSignersDerByteArrayLexOrder *EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_set_lexOrder(EsGobAfirmaCoreSignersDerByteArrayLexOrder *value);
static EsGobAfirmaCoreSignersDerByteArrayLexOrder *EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_lexOrder;
J2OBJC_STATIC_FIELD_OBJ(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC, lexOrder, EsGobAfirmaCoreSignersDerByteArrayLexOrder *)

/*!
 @brief Tag order comparison on byte arrays, for ordering elements of
   SET objects in DER encoding.
 */
inline EsGobAfirmaCoreSignersDerByteArrayTagOrder *EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_get_tagOrder(void);
inline EsGobAfirmaCoreSignersDerByteArrayTagOrder *EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_set_tagOrder(EsGobAfirmaCoreSignersDerByteArrayTagOrder *value);
static EsGobAfirmaCoreSignersDerByteArrayTagOrder *EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_tagOrder;
J2OBJC_STATIC_FIELD_OBJ(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC, tagOrder, EsGobAfirmaCoreSignersDerByteArrayTagOrder *)

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putIntegerContentsWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, jint i);

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, jbyte tag, IOSObjectArray *set, id<JavaUtilComparator> order);

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, NSString *s, jbyte stringTag, NSString *enc);

__attribute__((unused)) static void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putTimeWithJavaUtilDate_withByte_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, JavaUtilDate *d, jbyte tag);

#line 1 "/Users/desarrolloabamobile/Documents/JAVA/pades-ios/src/main/java/es/gob/afirma/core/signers/der/DerOutputStreamJ2OBJC.java"

J2OBJC_INITIALIZED_DEFN(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC)


#line 54
@implementation EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC


#line 61
- (instancetype)initWithInt:(jint)size {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_initWithInt_(self, size);
  return self;
}
...
#line 66
- (instancetype)init {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init(self);
  return self;
}
...
#line 95
  [self writeWithInt:tag];
  [self putLengthWithInt:((EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *) nil_chk(outArg))->count_];
...
withEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *)value {
  [self writeWithInt:tag];
  [self writeWithByteArray:((EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *) nil_chk(value))->buf_ withInt:1 withInt:value->count_ - 1];
}


#line 129
- (void)putDerValueWithEsGobAfirmaCoreSignersDerDerValue:(EsGobAfirmaCoreSignersDerDerValue *)val {
  [((EsGobAfirmaCoreSignersDerDerValue *) nil_chk(val)) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:self];
}
...
- (void)putEnumeratedWithInt:(jint)i {
  ...
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putIntegerContentsWithInt_(self, i);
}
...
- (void)putOIDWithEsGobAfirmaCoreSignersDerObjectIdentifier:(EsGobAfirmaCoreSignersDerObjectIdentifier *)oid {
  [((EsGobAfirmaCoreSignersDerObjectIdentifier *) nil_chk(oid)) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:self];
}


#line 323
- (void)putSequenceWithEsGobAfirmaCoreSignersDerDerValueArray:(IOSObjectArray *)seq {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *bytes = new_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init();
  jint i;
  
#line 327
  for (i = 0; i < ((IOSObjectArray *) nil_chk(seq))->size_; i++) {
    [((EsGobAfirmaCoreSignersDerDerValue *) nil_chk(IOSObjectArray_Get(seq, i))) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:bytes];
  }
  
#line 331
  [self writeWithByte:EsGobAfirmaCoreSignersDerDerValue_tag_Sequence withEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:bytes];
}
...
#line 347
  for (i = 0; i < ((IOSObjectArray *) nil_chk(set))->size_; i++) {
    [((EsGobAfirmaCoreSignersDerDerValue *) nil_chk(IOSObjectArray_Get(set, i))) encodeWithEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:bytes];
  }
  
#line 351
  [self writeWithByte:EsGobAfirmaCoreSignersDerDerValue_tag_Set withEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:bytes];
}
...
#line 368
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(self, tag, set, EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_lexOrder);
}
...
#line 385
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(self, tag, set, EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_tagOrder);
}
...
withEsGobAfirmaCoreSignersDerDerEncoderArray:(IOSObjectArray *)set
       withJavaUtilComparator:(id<JavaUtilComparator>)order {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(self, tag, set, order);
}


#line 437
- (void)putUTF8StringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_UTF8String, @"UTF8");
}


#line 446
- (void)putPrintableStringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_PrintableString, @"ASCII");
}
...
#line 460
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_T61String, @"ISO-8859-1");
}


#line 468
- (void)putIA5StringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_IA5String, @"ASCII");
}


#line 477
- (void)putBMPStringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_BMPString, @"UnicodeBigUnmarked");
}


#line 486
- (void)putGeneralStringWithNSString:(NSString *)s {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, EsGobAfirmaCoreSignersDerDerValue_tag_GeneralString, @"ASCII");
}
...
- (void)writeStringWithNSString:(NSString *)s
                       withByte:(jbyte)stringTag
                   withNSString:(NSString *)enc {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(self, s, stringTag, enc);
}


#line 516
- (void)putUTCTimeWithJavaUtilDate:(JavaUtilDate *)d {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putTimeWithJavaUtilDate_withByte_(self, d, EsGobAfirmaCoreSignersDerDerValue_tag_UtcTime);
}


#line 528
- (void)putGeneralizedTimeWithJavaUtilDate:(JavaUtilDate *)d {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putTimeWithJavaUtilDate_withByte_(self, d, EsGobAfirmaCoreSignersDerDerValue_tag_GeneralizedTime);
}
...
- (void)putTimeWithJavaUtilDate:(JavaUtilDate *)d
                       withByte:(jbyte)tag {
  EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putTimeWithJavaUtilDate_withByte_(self, d, tag);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(writeWithByte:withEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:);
  methods[4].selector = @selector(writeImplicitWithByte:withEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:);
  ...
  static const void *ptrTable[] = { "I", "write", "B[B", "LJavaIoIOException;", "BLEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC;", "writeImplicit", "putDerValue", "LEsGobAfirmaCoreSignersDerDerValue;", "putBoolean", "Z", "putEnumerated", "putInteger", "LJavaMathBigInteger;", "LJavaLangInteger;", "putIntegerContents", "putBitString", "[B", "putUnalignedBitString", "LEsGobAfirmaCoreSignersDerBitArray;", "putTruncatedUnalignedBitString", "putOctetString", "putOID", "LEsGobAfirmaCoreSignersDerObjectIdentifier;", "putSequence", "[LEsGobAfirmaCoreSignersDerDerValue;", "putSet", "putOrderedSetOf", "B[LEsGobAfirmaCoreSignersDerDerEncoder;", "putOrderedSet", "B[LEsGobAfirmaCoreSignersDerDerEncoder;LJavaUtilComparator;", "(B[Les/gob/afirma/core/signers/der/DerEncoder;Ljava/util/Comparator<[B>;)V", "putUTF8String", "LNSString;", "putPrintableString", "putT61String", "putIA5String", "putBMPString", "putGeneralString", "writeString", "LNSString;BLNSString;", "putUTCTime", "LJavaUtilDate;", "putGeneralizedTime", "putTime", "LJavaUtilDate;B", "putLength", "putTag", "BZB", "derEncode", "LJavaIoOutputStream;", &EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_lexOrder, &EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_tagOrder };
  static const J2ObjcClassInfo _EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC = { "DerOutputStreamJ2OBJC", "es.gob.afirma.core.signers.der", ptrTable, methods, fields, 7, 0x1, 36, 2, -1, -1, -1, -1, -1 };
  return &_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC;
}

+ (void)initialize {
  if (self == [EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC class]) {
    EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_lexOrder = new_EsGobAfirmaCoreSignersDerByteArrayLexOrder_init();
    EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_tagOrder = new_EsGobAfirmaCoreSignersDerByteArrayTagOrder_init();
    J2OBJC_SET_INITIALIZED(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC)
  }
}
...
#line 61
void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_initWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, jint size) {
...
#line 61
EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *new_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_initWithInt_(jint size) {
  J2OBJC_NEW_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC, initWithInt_, size)
}


#line 61
EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *create_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_initWithInt_(jint size) {
  J2OBJC_CREATE_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC, initWithInt_, size)
}


#line 66
void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self) {
  JavaIoByteArrayOutputStream_init(self);
}


#line 66
EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *new_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init() {
  J2OBJC_NEW_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC, init)
}


#line 66
EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *create_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init() {
  J2OBJC_CREATE_IMPL(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC, init)
}


#line 198
void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putIntegerContentsWithInt_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, jint i) {
...
#line 408
void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putOrderedSetWithByte_withEsGobAfirmaCoreSignersDerDerEncoderArray_withJavaUtilComparator_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, jbyte tag, IOSObjectArray *set, id<JavaUtilComparator> order) {
  
#line 410
  IOSObjectArray *streams = [IOSObjectArray newArrayWithLength:((IOSObjectArray *) nil_chk(set))->size_ type:EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_class_()];
  
#line 412
  for (jint i = 0; i < set->size_; i++) {
    (void) IOSObjectArray_SetAndConsume(streams, i, new_EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_init());
...
#line 418
  ...
  for (jint i = 0; i < streams->size_; i++) {
    (void) IOSObjectArray_Set(bufs, i, [((EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *) nil_chk(IOSObjectArray_Get(streams, i))) toByteArray]);
  }
...
#line 424
  ...
  [self writeWithByte:tag withEsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC:bytes];
}


#line 499
void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_writeStringWithNSString_withByte_withNSString_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, NSString *s, jbyte stringTag, NSString *enc) {
...
#line 540
void EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC_putTimeWithJavaUtilDate_withByte_(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC *self, JavaUtilDate *d, jbyte tag) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(EsGobAfirmaCoreSignersDerDerOutputStreamJ2OBJC)
