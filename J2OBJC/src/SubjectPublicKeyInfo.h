...
#pragma push_macro("INCLUDE_ALL_SubjectPublicKeyInfo")
#ifdef RESTRICT_SubjectPublicKeyInfo
#define INCLUDE_ALL_SubjectPublicKeyInfo 0
#else
#define INCLUDE_ALL_SubjectPublicKeyInfo 1
#endif
#undef RESTRICT_SubjectPublicKeyInfo

#if !defined (OrgSpongycastleAsn1X509SubjectPublicKeyInfo_) && (INCLUDE_ALL_SubjectPublicKeyInfo || defined(INCLUDE_OrgSpongycastleAsn1X509SubjectPublicKeyInfo))
...
#pragma pop_macro("INCLUDE_ALL_SubjectPublicKeyInfo")
