...
#pragma push_macro("INCLUDE_ALL_KeyStoreDialogManager")
#ifdef RESTRICT_KeyStoreDialogManager
#define INCLUDE_ALL_KeyStoreDialogManager 0
#else
#define INCLUDE_ALL_KeyStoreDialogManager 1
#endif
#undef RESTRICT_KeyStoreDialogManager

#if !defined (EsGobAfirmaCoreUiKeyStoreDialogManager_) && (INCLUDE_ALL_KeyStoreDialogManager || defined(INCLUDE_EsGobAfirmaCoreUiKeyStoreDialogManager))
...
#pragma pop_macro("INCLUDE_ALL_KeyStoreDialogManager")
