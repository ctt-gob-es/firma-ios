...
#pragma push_macro("INCLUDE_ALL_DocumentFont")
#ifdef RESTRICT_DocumentFont
#define INCLUDE_ALL_DocumentFont 0
#else
#define INCLUDE_ALL_DocumentFont 1
#endif
#undef RESTRICT_DocumentFont

#if !defined (ComAowagieTextPdfDocumentFont_) && (INCLUDE_ALL_DocumentFont || defined(INCLUDE_ComAowagieTextPdfDocumentFont))
...
#pragma pop_macro("INCLUDE_ALL_DocumentFont")
