...
#pragma push_macro("INCLUDE_ALL_ASN1TaggedObject")
#ifdef RESTRICT_ASN1TaggedObject
#define INCLUDE_ALL_ASN1TaggedObject 0
#else
#define INCLUDE_ALL_ASN1TaggedObject 1
#endif
#undef RESTRICT_ASN1TaggedObject

#if !defined (OrgSpongycastleAsn1ASN1TaggedObject_) && (INCLUDE_ALL_ASN1TaggedObject || defined(INCLUDE_OrgSpongycastleAsn1ASN1TaggedObject))
...
#pragma pop_macro("INCLUDE_ALL_ASN1TaggedObject")
