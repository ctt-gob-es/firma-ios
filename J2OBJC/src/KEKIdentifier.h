...
#pragma push_macro("INCLUDE_ALL_KEKIdentifier")
#ifdef RESTRICT_KEKIdentifier
#define INCLUDE_ALL_KEKIdentifier 0
#else
#define INCLUDE_ALL_KEKIdentifier 1
#endif
#undef RESTRICT_KEKIdentifier

#if !defined (OrgSpongycastleAsn1CmsKEKIdentifier_) && (INCLUDE_ALL_KEKIdentifier || defined(INCLUDE_OrgSpongycastleAsn1CmsKEKIdentifier))
...
#pragma pop_macro("INCLUDE_ALL_KEKIdentifier")
