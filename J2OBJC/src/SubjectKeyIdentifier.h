...
#pragma push_macro("INCLUDE_ALL_SubjectKeyIdentifier")
#ifdef RESTRICT_SubjectKeyIdentifier
#define INCLUDE_ALL_SubjectKeyIdentifier 0
#else
#define INCLUDE_ALL_SubjectKeyIdentifier 1
#endif
#undef RESTRICT_SubjectKeyIdentifier

#if !defined (OrgSpongycastleAsn1X509SubjectKeyIdentifier_) && (INCLUDE_ALL_SubjectKeyIdentifier || defined(INCLUDE_OrgSpongycastleAsn1X509SubjectKeyIdentifier))
...
#pragma pop_macro("INCLUDE_ALL_SubjectKeyIdentifier")
