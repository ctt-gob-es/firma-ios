...
#pragma push_macro("INCLUDE_ALL_BEROctetStringParser")
#ifdef RESTRICT_BEROctetStringParser
#define INCLUDE_ALL_BEROctetStringParser 0
#else
#define INCLUDE_ALL_BEROctetStringParser 1
#endif
#undef RESTRICT_BEROctetStringParser

#if !defined (OrgSpongycastleAsn1BEROctetStringParser_) && (INCLUDE_ALL_BEROctetStringParser || defined(INCLUDE_OrgSpongycastleAsn1BEROctetStringParser))
...
#pragma pop_macro("INCLUDE_ALL_BEROctetStringParser")
