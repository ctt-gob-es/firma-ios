...
#pragma push_macro("INCLUDE_ALL_DEROtherInfo")
#ifdef RESTRICT_DEROtherInfo
#define INCLUDE_ALL_DEROtherInfo 0
#else
#define INCLUDE_ALL_DEROtherInfo 1
#endif
#undef RESTRICT_DEROtherInfo

#if !defined (OrgSpongycastleCryptoUtilDEROtherInfo_) && (INCLUDE_ALL_DEROtherInfo || defined(INCLUDE_OrgSpongycastleCryptoUtilDEROtherInfo))
...
#if !defined (OrgSpongycastleCryptoUtilDEROtherInfo_Builder_) && (INCLUDE_ALL_DEROtherInfo || defined(INCLUDE_OrgSpongycastleCryptoUtilDEROtherInfo_Builder))
...
#pragma pop_macro("INCLUDE_ALL_DEROtherInfo")
