...
//  source: /Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/com/aowagie/text/pdf/DefaultFontMapper.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_DefaultFontMapper")
#ifdef RESTRICT_DefaultFontMapper
#define INCLUDE_ALL_DefaultFontMapper 0
#else
#define INCLUDE_ALL_DefaultFontMapper 1
#endif
#undef RESTRICT_DefaultFontMapper

#if !defined (ComAowagieTextPdfDefaultFontMapper_) && (INCLUDE_ALL_DefaultFontMapper || defined(INCLUDE_ComAowagieTextPdfDefaultFontMapper))
#define ComAowagieTextPdfDefaultFontMapper_

#define RESTRICT_FontMapper 1
...
#if !defined (ComAowagieTextPdfDefaultFontMapper_BaseFontParameters_) && (INCLUDE_ALL_DefaultFontMapper || defined(INCLUDE_ComAowagieTextPdfDefaultFontMapper_BaseFontParameters))
...
#pragma pop_macro("INCLUDE_ALL_DefaultFontMapper")
