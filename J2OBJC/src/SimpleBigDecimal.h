...
//  source: /Users/desarrolloabamobile/Documents/JAVA/pades-ios/src/main/java/org/spongycastle/math/ec/SimpleBigDecimal.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_SimpleBigDecimal")
#ifdef RESTRICT_SimpleBigDecimal
#define INCLUDE_ALL_SimpleBigDecimal 0
#else
#define INCLUDE_ALL_SimpleBigDecimal 1
#endif
#undef RESTRICT_SimpleBigDecimal

#if !defined (OrgSpongycastleMathEcSimpleBigDecimal_) && (INCLUDE_ALL_SimpleBigDecimal || defined(INCLUDE_OrgSpongycastleMathEcSimpleBigDecimal))
...
FOUNDATION_EXPORT void OrgSpongycastleMathEcSimpleBigDecimal_initPackagePrivateWithJavaMathBigInteger_withInt_(OrgSpongycastleMathEcSimpleBigDecimal *self, JavaMathBigInteger *bigInt, jint scale_);

FOUNDATION_EXPORT OrgSpongycastleMathEcSimpleBigDecimal *new_OrgSpongycastleMathEcSimpleBigDecimal_initPackagePrivateWithJavaMathBigInteger_withInt_(JavaMathBigInteger *bigInt, jint scale_) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgSpongycastleMathEcSimpleBigDecimal *create_OrgSpongycastleMathEcSimpleBigDecimal_initPackagePrivateWithJavaMathBigInteger_withInt_(JavaMathBigInteger *bigInt, jint scale_);

J2OBJC_TYPE_LITERAL_HEADER(OrgSpongycastleMathEcSimpleBigDecimal)

#endif

#pragma pop_macro("INCLUDE_ALL_SimpleBigDecimal")
