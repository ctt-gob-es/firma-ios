...
#pragma push_macro("INCLUDE_ALL_BigIntegers")
#ifdef RESTRICT_BigIntegers
#define INCLUDE_ALL_BigIntegers 0
#else
#define INCLUDE_ALL_BigIntegers 1
#endif
#undef RESTRICT_BigIntegers

#if !defined (OrgSpongycastleUtilBigIntegers_) && (INCLUDE_ALL_BigIntegers || defined(INCLUDE_OrgSpongycastleUtilBigIntegers))
...
#pragma pop_macro("INCLUDE_ALL_BigIntegers")
