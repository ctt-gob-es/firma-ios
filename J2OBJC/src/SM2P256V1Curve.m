...
#error "SM2P256V1Curve must be compiled with ARC (-fobjc-arc)"
#endif
...
#line 1 "/Users/desarrolloabamobile/Downloads/pades-ios-mini/src/main/java/org/spongycastle/math/ec/custom/gm/SM2P256V1Curve.java"
...
+ (void)initialize {
  if (self == [OrgSpongycastleMathEcCustomGmSM2P256V1Curve class]) {
    OrgSpongycastleMathEcCustomGmSM2P256V1Curve_q = new_JavaMathBigInteger_initWithInt_withByteArray_(
#line 12
