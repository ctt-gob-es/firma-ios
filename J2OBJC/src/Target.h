...
#pragma push_macro("INCLUDE_ALL_Target")
#ifdef RESTRICT_Target
#define INCLUDE_ALL_Target 0
#else
#define INCLUDE_ALL_Target 1
#endif
#undef RESTRICT_Target

#if !defined (OrgSpongycastleAsn1X509Target_) && (INCLUDE_ALL_Target || defined(INCLUDE_OrgSpongycastleAsn1X509Target))
...
#pragma pop_macro("INCLUDE_ALL_Target")
