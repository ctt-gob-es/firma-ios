...
#pragma push_macro("INCLUDE_ALL_Nat")
#ifdef RESTRICT_Nat
#define INCLUDE_ALL_Nat 0
#else
#define INCLUDE_ALL_Nat 1
#endif
#undef RESTRICT_Nat

#if !defined (OrgSpongycastleMathRawNat_) && (INCLUDE_ALL_Nat || defined(INCLUDE_OrgSpongycastleMathRawNat))
...
#pragma pop_macro("INCLUDE_ALL_Nat")
