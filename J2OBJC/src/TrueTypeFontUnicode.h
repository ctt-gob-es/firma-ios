...
#pragma push_macro("INCLUDE_ALL_TrueTypeFontUnicode")
#ifdef RESTRICT_TrueTypeFontUnicode
#define INCLUDE_ALL_TrueTypeFontUnicode 0
#else
#define INCLUDE_ALL_TrueTypeFontUnicode 1
#endif
#undef RESTRICT_TrueTypeFontUnicode

#if !defined (ComAowagieTextPdfTrueTypeFontUnicode_) && (INCLUDE_ALL_TrueTypeFontUnicode || defined(INCLUDE_ComAowagieTextPdfTrueTypeFontUnicode))
...
#pragma pop_macro("INCLUDE_ALL_TrueTypeFontUnicode")
