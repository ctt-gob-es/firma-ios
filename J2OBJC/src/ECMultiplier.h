...
#pragma push_macro("INCLUDE_ALL_ECMultiplier")
#ifdef RESTRICT_ECMultiplier
#define INCLUDE_ALL_ECMultiplier 0
#else
#define INCLUDE_ALL_ECMultiplier 1
#endif
#undef RESTRICT_ECMultiplier

#if !defined (OrgSpongycastleMathEcECMultiplier_) && (INCLUDE_ALL_ECMultiplier || defined(INCLUDE_OrgSpongycastleMathEcECMultiplier))
...
#pragma pop_macro("INCLUDE_ALL_ECMultiplier")
