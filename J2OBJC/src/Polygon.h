...
#pragma push_macro("INCLUDE_ALL_Polygon")
#ifdef RESTRICT_Polygon
#define INCLUDE_ALL_Polygon 0
#else
#define INCLUDE_ALL_Polygon 1
#endif
#undef RESTRICT_Polygon

#if !defined (HarmonyJavaAwtPolygon_) && (INCLUDE_ALL_Polygon || defined(INCLUDE_HarmonyJavaAwtPolygon))
...
#if !defined (HarmonyJavaAwtPolygon_Iterator_) && (INCLUDE_ALL_Polygon || defined(INCLUDE_HarmonyJavaAwtPolygon_Iterator))
...
#pragma pop_macro("INCLUDE_ALL_Polygon")
