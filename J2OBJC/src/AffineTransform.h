...
#pragma push_macro("INCLUDE_ALL_AffineTransform")
#ifdef RESTRICT_AffineTransform
#define INCLUDE_ALL_AffineTransform 0
#else
#define INCLUDE_ALL_AffineTransform 1
#endif
#undef RESTRICT_AffineTransform

#if !defined (HarmonyJavaAwtGeomAffineTransform_) && (INCLUDE_ALL_AffineTransform || defined(INCLUDE_HarmonyJavaAwtGeomAffineTransform))
...
#pragma pop_macro("INCLUDE_ALL_AffineTransform")
