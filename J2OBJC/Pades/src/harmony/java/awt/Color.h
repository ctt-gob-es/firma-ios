...
#pragma push_macro("INCLUDE_ALL_HarmonyJavaAwtColor")
#ifdef RESTRICT_HarmonyJavaAwtColor
#define INCLUDE_ALL_HarmonyJavaAwtColor 0
#else
#define INCLUDE_ALL_HarmonyJavaAwtColor 1
#endif
#undef RESTRICT_HarmonyJavaAwtColor

#if !defined (HarmonyJavaAwtColor_) && (INCLUDE_ALL_HarmonyJavaAwtColor || defined(INCLUDE_HarmonyJavaAwtColor))
...
#pragma pop_macro("INCLUDE_ALL_HarmonyJavaAwtColor")
