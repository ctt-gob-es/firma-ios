...
#include "harmony/java/awt/color/ICC_ColorSpace.h"
#include "harmony/java/awt/color/ICC_Profile.h"
#include "harmony/java/awt/color/ICC_ProfileStub.h"
...
#error "harmony/java/awt/color/ICC_ColorSpace must be compiled with ARC (-fobjc-arc)"
#endif
...
@interface HarmonyJavaAwtColorICC_ColorSpace () {
 @public
  ...
  OrgApacheHarmonyAwtGlColorICC_Transform *toRGBTransform_;
  OrgApacheHarmonyAwtGlColorICC_Transform *fromRGBTransform_;
  OrgApacheHarmonyAwtGlColorICC_Transform *toXYZTransform_;
  OrgApacheHarmonyAwtGlColorICC_Transform *fromXYZTransform_;
  OrgApacheHarmonyAwtGlColorColorConverter *converter_;
...
J2OBJC_FIELD_SETTER(HarmonyJavaAwtColorICC_ColorSpace, toRGBTransform_, OrgApacheHarmonyAwtGlColorICC_Transform *)
J2OBJC_FIELD_SETTER(HarmonyJavaAwtColorICC_ColorSpace, fromRGBTransform_, OrgApacheHarmonyAwtGlColorICC_Transform *)
J2OBJC_FIELD_SETTER(HarmonyJavaAwtColorICC_ColorSpace, toXYZTransform_, OrgApacheHarmonyAwtGlColorICC_Transform *)
J2OBJC_FIELD_SETTER(HarmonyJavaAwtColorICC_ColorSpace, fromXYZTransform_, OrgApacheHarmonyAwtGlColorICC_Transform *)
J2OBJC_FIELD_SETTER(HarmonyJavaAwtColorICC_ColorSpace, converter_, OrgApacheHarmonyAwtGlColorColorConverter *)
J2OBJC_FIELD_SETTER(HarmonyJavaAwtColorICC_ColorSpace, scaler_, OrgApacheHarmonyAwtGlColorColorScaler *)
...
#line 1 "/Users/desarrolloabamobile/Documents/JAVA/pades-ios/src/main/java/harmony/java/awt/color/ICC_ColorSpace.java"
...
#line 100
  if (toRGBTransform_ == nil) {
    ...
    toRGBTransform_ = new_OrgApacheHarmonyAwtGlColorICC_Transform_initWithHarmonyJavaAwtColorICC_ProfileArray_(profiles);
    if (!scalingDataLoaded_) {
      [((OrgApacheHarmonyAwtGlColorColorScaler *) nil_chk(scaler_)) loadScalingDataWithHarmonyJavaAwtColorColorSpace:self];
...
#line 112
  [((OrgApacheHarmonyAwtGlColorColorScaler *) nil_chk(scaler_)) scale__WithFloatArray:colorvalue withShortArray:data withInt:0];
  
#line 114
  IOSShortArray *converted = [((OrgApacheHarmonyAwtGlColorColorConverter *) nil_chk(converter_)) translateColorWithOrgApacheHarmonyAwtGlColorICC_Transform:toRGBTransform_ withShortArray:data withShortArray:nil];
...
#line 128
  if (toXYZTransform_ == nil) {
    ...
    @try {
      ...
      toXYZTransform_ = new_OrgApacheHarmonyAwtGlColorICC_Transform_initWithHarmonyJavaAwtColorICC_ProfileArray_withIntArray_(profiles, intents);
    }
    @catch (
#line 134
    HarmonyJavaAwtColorCMMException *e) {
      toXYZTransform_ = new_OrgApacheHarmonyAwtGlColorICC_Transform_initWithHarmonyJavaAwtColorICC_ProfileArray_(profiles);
    }
...
#line 148
  IOSShortArray *converted = [((OrgApacheHarmonyAwtGlColorColorConverter *) nil_chk(converter_)) translateColorWithOrgApacheHarmonyAwtGlColorICC_Transform:toXYZTransform_ withShortArray:data withShortArray:nil];
...
#line 162
  if (fromRGBTransform_ == nil) {
    ...
    fromRGBTransform_ = new_OrgApacheHarmonyAwtGlColorICC_Transform_initWithHarmonyJavaAwtColorICC_ProfileArray_(profiles);
    if (!scalingDataLoaded_) {
      [((OrgApacheHarmonyAwtGlColorColorScaler *) nil_chk(scaler_)) loadScalingDataWithHarmonyJavaAwtColorColorSpace:self];
      scalingDataLoaded_ = true;
    }
...
#line 178
  IOSShortArray *converted = [((OrgApacheHarmonyAwtGlColorColorConverter *) nil_chk(converter_)) translateColorWithOrgApacheHarmonyAwtGlColorICC_Transform:fromRGBTransform_ withShortArray:scaledRGBValue withShortArray:nil];
  
#line 180
  IOSFloatArray *res = [IOSFloatArray newArrayWithLength:[self getNumComponents]];
  
#line 182
  [((OrgApacheHarmonyAwtGlColorColorScaler *) nil_chk(scaler_)) unscaleWithFloatArray:res withShortArray:converted withInt:0];
...
#line 189
  if (fromXYZTransform_ == nil) {
    ...
    @try {
      ...
      fromXYZTransform_ = new_OrgApacheHarmonyAwtGlColorICC_Transform_initWithHarmonyJavaAwtColorICC_ProfileArray_withIntArray_(profiles, intents);
    }
    @catch (
#line 195
    HarmonyJavaAwtColorCMMException *e) {
      fromXYZTransform_ = new_OrgApacheHarmonyAwtGlColorICC_Transform_initWithHarmonyJavaAwtColorICC_ProfileArray_(profiles);
    }
...
#line 211
  IOSShortArray *converted = [((OrgApacheHarmonyAwtGlColorColorConverter *) nil_chk(converter_)) translateColorWithOrgApacheHarmonyAwtGlColorICC_Transform:fromXYZTransform_ withShortArray:scaledXYZValue withShortArray:nil];
...
#line 224
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(OrgApacheHarmonyAwtInternalNlsMessages_getStringWithNSString_(@"awt.169"));
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "toRGBTransform_", "LOrgApacheHarmonyAwtGlColorICC_Transform;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "fromRGBTransform_", "LOrgApacheHarmonyAwtGlColorICC_Transform;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "toXYZTransform_", "LOrgApacheHarmonyAwtGlColorICC_Transform;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "fromXYZTransform_", "LOrgApacheHarmonyAwtGlColorICC_Transform;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "converter_", "LOrgApacheHarmonyAwtGlColorColorConverter;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
    { "scaler_", "LOrgApacheHarmonyAwtGlColorColorScaler;", .constantValue.asLong = 0, 0x12, -1, -1, -1, -1 },
...
#line 59
  ...
  self->converter_ = new_OrgApacheHarmonyAwtGlColorColorConverter_init();
...
#line 83
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(OrgApacheHarmonyAwtInternalNlsMessages_getStringWithNSString_(@"awt.168"));
  }
