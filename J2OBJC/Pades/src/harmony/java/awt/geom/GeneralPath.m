...
#error "harmony/java/awt/geom/GeneralPath must be compiled with ARC (-fobjc-arc)"
#endif
...
#line 1 "/Users/desarrolloabamobile/Documents/JAVA/pades-ios/src/main/java/harmony/java/awt/geom/GeneralPath.java"
...
#line 198
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(OrgApacheHarmonyAwtInternalNlsMessages_getStringWithNSString_(@"awt.209"));
  }
  self->rule_ = rule;
}
...
#line 217
    @throw new_HarmonyJavaAwtGeomIllegalPathStateException_initWithNSString_(OrgApacheHarmonyAwtInternalNlsMessages_getStringWithNSString_(@"awt.20A"));
  }
...
#line 395
  return [self isInsideWithInt:OrgApacheHarmonyAwtGlCrossing_crossShapeWithHarmonyJavaAwtShape_withDouble_withDouble_(self, px, py)];
}
...
#line 399
  ...
  return cross != OrgApacheHarmonyAwtGlCrossing_CROSSING && [self isInsideWithInt:cross];
}
