...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfFontMapper")
#ifdef RESTRICT_ComAowagieTextPdfFontMapper
#define INCLUDE_ALL_ComAowagieTextPdfFontMapper 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfFontMapper 1
#endif
#undef RESTRICT_ComAowagieTextPdfFontMapper

#if !defined (ComAowagieTextPdfFontMapper_) && (INCLUDE_ALL_ComAowagieTextPdfFontMapper || defined(INCLUDE_ComAowagieTextPdfFontMapper))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfFontMapper")
