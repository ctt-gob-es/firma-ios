...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfPdfLine")
#ifdef RESTRICT_ComAowagieTextPdfPdfLine
#define INCLUDE_ALL_ComAowagieTextPdfPdfLine 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfPdfLine 1
#endif
#undef RESTRICT_ComAowagieTextPdfPdfLine

#if !defined (ComAowagieTextPdfPdfLine_) && (INCLUDE_ALL_ComAowagieTextPdfPdfLine || defined(INCLUDE_ComAowagieTextPdfPdfLine))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfPdfLine")
