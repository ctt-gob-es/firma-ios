...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfIntHashtable")
#ifdef RESTRICT_ComAowagieTextPdfIntHashtable
#define INCLUDE_ALL_ComAowagieTextPdfIntHashtable 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfIntHashtable 1
#endif
#undef RESTRICT_ComAowagieTextPdfIntHashtable

#if !defined (ComAowagieTextPdfIntHashtable_) && (INCLUDE_ALL_ComAowagieTextPdfIntHashtable || defined(INCLUDE_ComAowagieTextPdfIntHashtable))
...
#if !defined (ComAowagieTextPdfIntHashtable_Entry_) && (INCLUDE_ALL_ComAowagieTextPdfIntHashtable || defined(INCLUDE_ComAowagieTextPdfIntHashtable_Entry))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfIntHashtable")
