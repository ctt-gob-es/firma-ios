...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfHyphenationHyphenationTree")
#ifdef RESTRICT_ComAowagieTextPdfHyphenationHyphenationTree
#define INCLUDE_ALL_ComAowagieTextPdfHyphenationHyphenationTree 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfHyphenationHyphenationTree 1
#endif
#undef RESTRICT_ComAowagieTextPdfHyphenationHyphenationTree

#if !defined (ComAowagieTextPdfHyphenationHyphenationTree_) && (INCLUDE_ALL_ComAowagieTextPdfHyphenationHyphenationTree || defined(INCLUDE_ComAowagieTextPdfHyphenationHyphenationTree))
#define ComAowagieTextPdfHyphenationHyphenationTree_

#define RESTRICT_ComAowagieTextPdfHyphenationTernaryTree 1
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfHyphenationHyphenationTree")
