...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPdfPdfContentParser")
#ifdef RESTRICT_ComAowagieTextPdfPdfContentParser
#define INCLUDE_ALL_ComAowagieTextPdfPdfContentParser 0
#else
#define INCLUDE_ALL_ComAowagieTextPdfPdfContentParser 1
#endif
#undef RESTRICT_ComAowagieTextPdfPdfContentParser

#if !defined (ComAowagieTextPdfPdfContentParser_) && (INCLUDE_ALL_ComAowagieTextPdfPdfContentParser || defined(INCLUDE_ComAowagieTextPdfPdfContentParser))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPdfPdfContentParser")
