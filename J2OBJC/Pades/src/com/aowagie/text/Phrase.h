...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextPhrase")
#ifdef RESTRICT_ComAowagieTextPhrase
#define INCLUDE_ALL_ComAowagieTextPhrase 0
#else
#define INCLUDE_ALL_ComAowagieTextPhrase 1
#endif
#undef RESTRICT_ComAowagieTextPhrase

#if !defined (ComAowagieTextPhrase_) && (INCLUDE_ALL_ComAowagieTextPhrase || defined(INCLUDE_ComAowagieTextPhrase))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextPhrase")
