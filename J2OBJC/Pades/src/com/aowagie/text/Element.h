...
#pragma push_macro("INCLUDE_ALL_ComAowagieTextElement")
#ifdef RESTRICT_ComAowagieTextElement
#define INCLUDE_ALL_ComAowagieTextElement 0
#else
#define INCLUDE_ALL_ComAowagieTextElement 1
#endif
#undef RESTRICT_ComAowagieTextElement

#if !defined (ComAowagieTextElement_) && (INCLUDE_ALL_ComAowagieTextElement || defined(INCLUDE_ComAowagieTextElement))
...
#pragma pop_macro("INCLUDE_ALL_ComAowagieTextElement")
