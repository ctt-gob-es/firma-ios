...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleJceExceptionExtCertPathValidatorException")
#ifdef RESTRICT_OrgSpongycastleJceExceptionExtCertPathValidatorException
#define INCLUDE_ALL_OrgSpongycastleJceExceptionExtCertPathValidatorException 0
#else
#define INCLUDE_ALL_OrgSpongycastleJceExceptionExtCertPathValidatorException 1
#endif
#undef RESTRICT_OrgSpongycastleJceExceptionExtCertPathValidatorException

#if !defined (OrgSpongycastleJceExceptionExtCertPathValidatorException_) && (INCLUDE_ALL_OrgSpongycastleJceExceptionExtCertPathValidatorException || defined(INCLUDE_OrgSpongycastleJceExceptionExtCertPathValidatorException))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleJceExceptionExtCertPathValidatorException")
