...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi")
#ifdef RESTRICT_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi
#define INCLUDE_ALL_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi 0
#else
#define INCLUDE_ALL_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi 1
#endif
#undef RESTRICT_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi

#if !defined (OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi_) && (INCLUDE_ALL_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi || defined(INCLUDE_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleJceProviderPKIXAttrCertPathBuilderSpi")
