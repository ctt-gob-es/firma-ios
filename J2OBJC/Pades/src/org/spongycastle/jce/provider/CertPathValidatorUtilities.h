...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleJceProviderCertPathValidatorUtilities")
#ifdef RESTRICT_OrgSpongycastleJceProviderCertPathValidatorUtilities
#define INCLUDE_ALL_OrgSpongycastleJceProviderCertPathValidatorUtilities 0
#else
#define INCLUDE_ALL_OrgSpongycastleJceProviderCertPathValidatorUtilities 1
#endif
#undef RESTRICT_OrgSpongycastleJceProviderCertPathValidatorUtilities

#if !defined (OrgSpongycastleJceProviderCertPathValidatorUtilities_) && (INCLUDE_ALL_OrgSpongycastleJceProviderCertPathValidatorUtilities || defined(INCLUDE_OrgSpongycastleJceProviderCertPathValidatorUtilities))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleJceProviderCertPathValidatorUtilities")
