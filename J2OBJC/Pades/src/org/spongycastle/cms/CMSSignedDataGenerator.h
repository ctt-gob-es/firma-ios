...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleCmsCMSSignedDataGenerator")
#ifdef RESTRICT_OrgSpongycastleCmsCMSSignedDataGenerator
#define INCLUDE_ALL_OrgSpongycastleCmsCMSSignedDataGenerator 0
#else
#define INCLUDE_ALL_OrgSpongycastleCmsCMSSignedDataGenerator 1
#endif
#undef RESTRICT_OrgSpongycastleCmsCMSSignedDataGenerator

#if !defined (OrgSpongycastleCmsCMSSignedDataGenerator_) && (INCLUDE_ALL_OrgSpongycastleCmsCMSSignedDataGenerator || defined(INCLUDE_OrgSpongycastleCmsCMSSignedDataGenerator))
#define OrgSpongycastleCmsCMSSignedDataGenerator_

#define RESTRICT_OrgSpongycastleCmsCMSSignedGenerator 1
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleCmsCMSSignedDataGenerator")
