...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleMathRawMod")
#ifdef RESTRICT_OrgSpongycastleMathRawMod
#define INCLUDE_ALL_OrgSpongycastleMathRawMod 0
#else
#define INCLUDE_ALL_OrgSpongycastleMathRawMod 1
#endif
#undef RESTRICT_OrgSpongycastleMathRawMod

#if !defined (OrgSpongycastleMathRawMod_) && (INCLUDE_ALL_OrgSpongycastleMathRawMod || defined(INCLUDE_OrgSpongycastleMathRawMod))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleMathRawMod")
