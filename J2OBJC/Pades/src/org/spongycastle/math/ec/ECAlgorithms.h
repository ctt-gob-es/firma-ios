...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleMathEcECAlgorithms")
#ifdef RESTRICT_OrgSpongycastleMathEcECAlgorithms
#define INCLUDE_ALL_OrgSpongycastleMathEcECAlgorithms 0
#else
#define INCLUDE_ALL_OrgSpongycastleMathEcECAlgorithms 1
#endif
#undef RESTRICT_OrgSpongycastleMathEcECAlgorithms

#if !defined (OrgSpongycastleMathEcECAlgorithms_) && (INCLUDE_ALL_OrgSpongycastleMathEcECAlgorithms || defined(INCLUDE_OrgSpongycastleMathEcECAlgorithms))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleMathEcECAlgorithms")
