...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1PkcsPrivateKeyInfo")
#ifdef RESTRICT_OrgSpongycastleAsn1PkcsPrivateKeyInfo
#define INCLUDE_ALL_OrgSpongycastleAsn1PkcsPrivateKeyInfo 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1PkcsPrivateKeyInfo 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1PkcsPrivateKeyInfo

#if !defined (OrgSpongycastleAsn1PkcsPrivateKeyInfo_) && (INCLUDE_ALL_OrgSpongycastleAsn1PkcsPrivateKeyInfo || defined(INCLUDE_OrgSpongycastleAsn1PkcsPrivateKeyInfo))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1PkcsPrivateKeyInfo")
