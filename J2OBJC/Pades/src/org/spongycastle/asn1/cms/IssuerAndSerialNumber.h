...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1CmsIssuerAndSerialNumber")
#ifdef RESTRICT_OrgSpongycastleAsn1CmsIssuerAndSerialNumber
#define INCLUDE_ALL_OrgSpongycastleAsn1CmsIssuerAndSerialNumber 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1CmsIssuerAndSerialNumber 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1CmsIssuerAndSerialNumber

#if !defined (OrgSpongycastleAsn1CmsIssuerAndSerialNumber_) && (INCLUDE_ALL_OrgSpongycastleAsn1CmsIssuerAndSerialNumber || defined(INCLUDE_OrgSpongycastleAsn1CmsIssuerAndSerialNumber))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1CmsIssuerAndSerialNumber")
