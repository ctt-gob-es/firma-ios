...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleAsn1GmGMNamedCurves")
#ifdef RESTRICT_OrgSpongycastleAsn1GmGMNamedCurves
#define INCLUDE_ALL_OrgSpongycastleAsn1GmGMNamedCurves 0
#else
#define INCLUDE_ALL_OrgSpongycastleAsn1GmGMNamedCurves 1
#endif
#undef RESTRICT_OrgSpongycastleAsn1GmGMNamedCurves

#if !defined (OrgSpongycastleAsn1GmGMNamedCurves_) && (INCLUDE_ALL_OrgSpongycastleAsn1GmGMNamedCurves || defined(INCLUDE_OrgSpongycastleAsn1GmGMNamedCurves))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleAsn1GmGMNamedCurves")
