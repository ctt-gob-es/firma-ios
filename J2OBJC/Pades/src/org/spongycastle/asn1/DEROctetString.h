...
@class OrgSpongycastleAsn1BCDEROutputStream;
...
FOUNDATION_EXPORT void OrgSpongycastleAsn1DEROctetString_encodeWithOrgSpongycastleAsn1BCDEROutputStream_withByteArray_(OrgSpongycastleAsn1BCDEROutputStream *derOut, IOSByteArray *bytes);
