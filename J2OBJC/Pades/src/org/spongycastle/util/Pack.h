...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleUtilPack")
#ifdef RESTRICT_OrgSpongycastleUtilPack
#define INCLUDE_ALL_OrgSpongycastleUtilPack 0
#else
#define INCLUDE_ALL_OrgSpongycastleUtilPack 1
#endif
#undef RESTRICT_OrgSpongycastleUtilPack

#if !defined (OrgSpongycastleUtilPack_) && (INCLUDE_ALL_OrgSpongycastleUtilPack || defined(INCLUDE_OrgSpongycastleUtilPack))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleUtilPack")
