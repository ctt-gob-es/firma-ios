...
#pragma push_macro("INCLUDE_ALL_OrgSpongycastleOperatorContentSigner")
#ifdef RESTRICT_OrgSpongycastleOperatorContentSigner
#define INCLUDE_ALL_OrgSpongycastleOperatorContentSigner 0
#else
#define INCLUDE_ALL_OrgSpongycastleOperatorContentSigner 1
#endif
#undef RESTRICT_OrgSpongycastleOperatorContentSigner

#if !defined (OrgSpongycastleOperatorContentSigner_) && (INCLUDE_ALL_OrgSpongycastleOperatorContentSigner || defined(INCLUDE_OrgSpongycastleOperatorContentSigner))
...
#pragma pop_macro("INCLUDE_ALL_OrgSpongycastleOperatorContentSigner")
