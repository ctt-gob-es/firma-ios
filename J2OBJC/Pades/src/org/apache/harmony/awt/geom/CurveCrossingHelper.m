...
#error "org/apache/harmony/awt/geom/CurveCrossingHelper must be compiled with ARC (-fobjc-arc)"
#endif

@interface OrgApacheHarmonyAwtGeomCurveCrossingHelper () {
 @public
...
J2OBJC_FIELD_SETTER(OrgApacheHarmonyAwtGeomCurveCrossingHelper, coords_, IOSObjectArray *)
J2OBJC_FIELD_SETTER(OrgApacheHarmonyAwtGeomCurveCrossingHelper, rules_, IOSObjectArray *)
J2OBJC_FIELD_SETTER(OrgApacheHarmonyAwtGeomCurveCrossingHelper, sizes_, IOSIntArray *)
J2OBJC_FIELD_SETTER(OrgApacheHarmonyAwtGeomCurveCrossingHelper, rulesSizes_, IOSIntArray *)
J2OBJC_FIELD_SETTER(OrgApacheHarmonyAwtGeomCurveCrossingHelper, offsets_, IOSObjectArray *)
J2OBJC_FIELD_SETTER(OrgApacheHarmonyAwtGeomCurveCrossingHelper, isectPoints_, id<JavaUtilList>)

__attribute__((unused)) static jint OrgApacheHarmonyAwtGeomCurveCrossingHelper_getCurrentEdgeWithInt_withInt_withDoubleArray_withDoubleArray_withDoubleArray_(OrgApacheHarmonyAwtGeomCurveCrossingHelper *self, jint areaIndex, jint index, IOSDoubleArray *c, IOSDoubleArray *mp, IOSDoubleArray *cp);

__attribute__((unused)) static jboolean OrgApacheHarmonyAwtGeomCurveCrossingHelper_containsPointWithDouble_withDouble_(OrgApacheHarmonyAwtGeomCurveCrossingHelper *self, jdouble x, jdouble y);

#line 1 "/Users/desarrolloabamobile/Documents/JAVA/pades-ios/src/main/java/org/apache/harmony/awt/geom/CurveCrossingHelper.java"


#line 25
@implementation OrgApacheHarmonyAwtGeomCurveCrossingHelper
...
- (instancetype)initWithDoubleArray2:(IOSObjectArray *)coords
  ...
  OrgApacheHarmonyAwtGeomCurveCrossingHelper_initWithDoubleArray2_withIntArray_withIntArray2_withIntArray_withIntArray2_(self, coords, sizes, rules, rulesSizes, offsets);
  return self;
}
...
#line 53
  for (jint i = 0; i < IOSIntArray_Get(nil_chk(rulesSizes_), 0); i++) {
    ...
    endIndex1 = OrgApacheHarmonyAwtGeomCurveCrossingHelper_getCurrentEdgeWithInt_withInt_withDoubleArray_withDoubleArray_withDoubleArray_(self, 0, i, edge1, mp1, cp1);
    for (jint j = 0; j < IOSIntArray_Get(nil_chk(rulesSizes_), 1); j++) {
      ...
      endIndex2 = OrgApacheHarmonyAwtGeomCurveCrossingHelper_getCurrentEdgeWithInt_withInt_withDoubleArray_withDoubleArray_withDoubleArray_(self, 1, j, edge2, mp2, cp2);
...
#line 63
        ipCount = OrgApacheHarmonyAwtGeomGeometryUtil_intersectLinesWithParamsWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge2, 0), IOSDoubleArray_Get(
#line 64
        edge2, 1), IOSDoubleArray_Get(edge2, 2), IOSDoubleArray_Get(edge2, 3), params);
        
#line 66
        if (ipCount != 0) {
          *IOSDoubleArray_GetRef(points, 0) = OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 0), IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 2));
          *IOSDoubleArray_GetRef(points, 1) = OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 3));
        }
      }
      else
#line 70
...
#line 71
      (rule2 == HarmonyJavaAwtGeomPathIterator_SEG_QUADTO)) {
        ipCount = OrgApacheHarmonyAwtGeomGeometryUtil_intersectLineAndQuadWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge2, 0), IOSDoubleArray_Get(
#line 73
        ...
        for (jint k = 0; k < ipCount; k++) {
          *IOSDoubleArray_GetRef(points, 2 * k) = OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k), IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 2));
          *IOSDoubleArray_GetRef(points, 2 * k + 1) = OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 3));
        }
      }
      else
#line 78
...
#line 81
        ...
        for (jint k = 0; k < ipCount; k++) {
          *IOSDoubleArray_GetRef(points, 2 * k) = OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k + 1), IOSDoubleArray_Get(edge2, 0), IOSDoubleArray_Get(edge2, 2));
          *IOSDoubleArray_GetRef(points, 2 * k + 1) = OrgApacheHarmonyAwtGeomGeometryUtil_lineWithDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k + 1), IOSDoubleArray_Get(edge2, 1), IOSDoubleArray_Get(edge2, 3));
        }
      }
      else
#line 86
...
#line 87
      ((rule2 == HarmonyJavaAwtGeomPathIterator_SEG_LINETO) || (rule2 == HarmonyJavaAwtGeomPathIterator_SEG_CLOSE))) {
        ipCount = OrgApacheHarmonyAwtGeomGeometryUtil_intersectLineAndCubicWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge1, 4), IOSDoubleArray_Get(
#line 89
...
#line 104
      if ((rule1 == HarmonyJavaAwtGeomPathIterator_SEG_QUADTO) && (rule2 == HarmonyJavaAwtGeomPathIterator_SEG_QUADTO)) {
        ipCount = OrgApacheHarmonyAwtGeomGeometryUtil_intersectQuadsWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge1, 4), IOSDoubleArray_Get(edge1, 5), IOSDoubleArray_Get(
#line 106
        ...
        for (jint k = 0; k < ipCount; k++) {
          *IOSDoubleArray_GetRef(points, 2 * k) = OrgApacheHarmonyAwtGeomGeometryUtil_quadWithDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k), IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 4));
          *IOSDoubleArray_GetRef(points, 2 * k + 1) = OrgApacheHarmonyAwtGeomGeometryUtil_quadWithDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge1, 5));
        }
      }
      else
#line 111
      if ((rule1 == HarmonyJavaAwtGeomPathIterator_SEG_QUADTO) && (rule2 == HarmonyJavaAwtGeomPathIterator_SEG_CUBICTO)) {
        ipCount = OrgApacheHarmonyAwtGeomGeometryUtil_intersectQuadAndCubicWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge1, 4), IOSDoubleArray_Get(
#line 113
...
#line 125
        for (jint k = 0; k < ipCount; k++) {
          *IOSDoubleArray_GetRef(points, 2 * k) = OrgApacheHarmonyAwtGeomGeometryUtil_quadWithDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k + 1), IOSDoubleArray_Get(edge2, 0), IOSDoubleArray_Get(edge2, 2), IOSDoubleArray_Get(edge2, 4));
          *IOSDoubleArray_GetRef(points, 2 * k + 1) = OrgApacheHarmonyAwtGeomGeometryUtil_quadWithDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k + 1), IOSDoubleArray_Get(edge2, 1), IOSDoubleArray_Get(edge2, 3), IOSDoubleArray_Get(edge2, 5));
        }
      }
      else
#line 129
      if ((rule1 == HarmonyJavaAwtGeomPathIterator_SEG_CUBICTO) && (rule2 == HarmonyJavaAwtGeomPathIterator_SEG_CUBICTO)) {
        ipCount = OrgApacheHarmonyAwtGeomGeometryUtil_intersectCubicsWithDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDouble_withDoubleArray_(IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge1, 4), IOSDoubleArray_Get(edge1, 5), IOSDoubleArray_Get(
#line 131
...
#line 134
        for (jint k = 0; k < ipCount; k++) {
          *IOSDoubleArray_GetRef(points, 2 * k) = OrgApacheHarmonyAwtGeomGeometryUtil_cubicWithDouble_withDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k), IOSDoubleArray_Get(edge1, 0), IOSDoubleArray_Get(edge1, 2), IOSDoubleArray_Get(edge1, 4), IOSDoubleArray_Get(edge1, 6));
          *IOSDoubleArray_GetRef(points, 2 * k + 1) = OrgApacheHarmonyAwtGeomGeometryUtil_cubicWithDouble_withDouble_withDouble_withDouble_withDouble_(IOSDoubleArray_Get(params, 2 * k), IOSDoubleArray_Get(edge1, 1), IOSDoubleArray_Get(edge1, 3), IOSDoubleArray_Get(edge1, 5), IOSDoubleArray_Get(edge1, 7));
        }
      }
...
#line 145
      for (jint k = 0; k < ipCount; k++) {
        OrgApacheHarmonyAwtGeomIntersectPoint *ip = nil;
        if (!OrgApacheHarmonyAwtGeomCurveCrossingHelper_containsPointWithDouble_withDouble_(self, IOSDoubleArray_Get(points, 2 * k), IOSDoubleArray_Get(points, 2 * k + 1))) {
          for (id<JavaUtilIterator> iter = [((id<JavaUtilList>) nil_chk(isectPoints_)) iterator]; [((id<JavaUtilIterator>) nil_chk(iter)) hasNext]; ) {
            ip = [iter next];
            if ((begIndex1 == [((OrgApacheHarmonyAwtGeomIntersectPoint *) nil_chk(ip)) getBegIndexWithBoolean:true]) && (endIndex1 == [ip getEndIndexWithBoolean:true])) {
...
#line 181
          [((id<JavaUtilList>) nil_chk(isectPoints_)) addWithId:new_OrgApacheHarmonyAwtGeomIntersectPoint_initWithInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withDouble_withDouble_withDouble_withDouble_(begIndex1, endIndex1, rule1, i, begIndex2, endIndex2, rule2,
#line 182
...
- (jint)getCurrentEdgeWithInt:(jint)areaIndex
              ...
              withDoubleArray:(IOSDoubleArray *)mp
              withDoubleArray:(IOSDoubleArray *)cp {
  return OrgApacheHarmonyAwtGeomCurveCrossingHelper_getCurrentEdgeWithInt_withInt_withDoubleArray_withDoubleArray_withDoubleArray_(self, areaIndex, index, c, mp, cp);
}
...
- (jboolean)containsPointWithDouble:(jdouble)x
                         withDouble:(jdouble)y {
  return OrgApacheHarmonyAwtGeomCurveCrossingHelper_containsPointWithDouble_withDouble_(self, x, y);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "[[D[I[[I[I[[I", "getCurrentEdge", "II[D[D[D", "containsPoint", "DD", "Ljava/util/List<Lorg/apache/harmony/awt/geom/IntersectPoint;>;" };
  static const J2ObjcClassInfo _OrgApacheHarmonyAwtGeomCurveCrossingHelper = { "CurveCrossingHelper", "org.apache.harmony.awt.geom", ptrTable, methods, fields, 7, 0x1, 4, 6, -1, -1, -1, -1, -1 };
  return &_OrgApacheHarmonyAwtGeomCurveCrossingHelper;
}
...
#line 33
void OrgApacheHarmonyAwtGeomCurveCrossingHelper_initWithDoubleArray2_withIntArray_withIntArray2_withIntArray_withIntArray2_(OrgApacheHarmonyAwtGeomCurveCrossingHelper *self, IOSObjectArray *coords, IOSIntArray *sizes, IOSObjectArray *rules, IOSIntArray *rulesSizes, IOSObjectArray *offsets) {
  NSObject_init(self);
...
#line 33
OrgApacheHarmonyAwtGeomCurveCrossingHelper *new_OrgApacheHarmonyAwtGeomCurveCrossingHelper_initWithDoubleArray2_withIntArray_withIntArray2_withIntArray_withIntArray2_(IOSObjectArray *coords, IOSIntArray *sizes, IOSObjectArray *rules, IOSIntArray *rulesSizes, IOSObjectArray *offsets) {
  J2OBJC_NEW_IMPL(OrgApacheHarmonyAwtGeomCurveCrossingHelper, initWithDoubleArray2_withIntArray_withIntArray2_withIntArray_withIntArray2_, coords, sizes, rules, rulesSizes, offsets)
}


#line 33
OrgApacheHarmonyAwtGeomCurveCrossingHelper *create_OrgApacheHarmonyAwtGeomCurveCrossingHelper_initWithDoubleArray2_withIntArray_withIntArray2_withIntArray_withIntArray2_(IOSObjectArray *coords, IOSIntArray *sizes, IOSObjectArray *rules, IOSIntArray *rulesSizes, IOSObjectArray *offsets) {
  J2OBJC_CREATE_IMPL(OrgApacheHarmonyAwtGeomCurveCrossingHelper, initWithDoubleArray2_withIntArray_withIntArray2_withIntArray_withIntArray2_, coords, sizes, rules, rulesSizes, offsets)
}


#line 190
jint OrgApacheHarmonyAwtGeomCurveCrossingHelper_getCurrentEdgeWithInt_withInt_withDoubleArray_withDoubleArray_withDoubleArray_(OrgApacheHarmonyAwtGeomCurveCrossingHelper *self, jint areaIndex, jint index, IOSDoubleArray *c, IOSDoubleArray *mp, IOSDoubleArray *cp) {
  jint endIndex = 0;
...
#line 240
jboolean OrgApacheHarmonyAwtGeomCurveCrossingHelper_containsPointWithDouble_withDouble_(OrgApacheHarmonyAwtGeomCurveCrossingHelper *self, jdouble x, jdouble y) {
...
#line 246
    if ((JavaLangMath_absWithDouble_([((OrgApacheHarmonyAwtGeomIntersectPoint *) nil_chk(ipoint)) getX] - x) < JavaLangMath_powWithDouble_withDouble_(10, -6)) && (JavaLangMath_absWithDouble_([ipoint getY] - y) < JavaLangMath_powWithDouble_withDouble_(10, -6))) {
      return true;
    }
  }
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgApacheHarmonyAwtGeomCurveCrossingHelper)
